...
// ContextValidate validate this io k8s api authorization v1 subject access review based on the context it is used
func (m *IoK8sAPIAuthorizationV1SubjectAccessReview) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAuthorizationV1SubjectAccessReview) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIAuthorizationV1SubjectAccessReview) contextValidateSpec(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIAuthorizationV1SubjectAccessReview) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
