...
// ContextValidate validates this io k8s api flowcontrol v1alpha1 service account subject based on context it is used
func (m *IoK8sAPIFlowcontrolV1alpha1ServiceAccountSubject) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
