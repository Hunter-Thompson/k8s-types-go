...
// ContextValidate validate this io k8s api storage v1 volume attachment spec based on the context it is used
func (m *IoK8sAPIStorageV1VolumeAttachmentSpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIStorageV1VolumeAttachmentSpec) contextValidateSource(ctx context.Context, formats strfmt.Registry) error {
