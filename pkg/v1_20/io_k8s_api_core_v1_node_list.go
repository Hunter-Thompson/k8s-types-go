...
type IoK8sAPICoreV1NodeList struct {
	...
	// List of nodes
	// Required: true
	Items []*IoK8sAPICoreV1Node `json:"items" json,yaml:"items"`
...
// ContextValidate validate this io k8s api core v1 node list based on the context it is used
func (m *IoK8sAPICoreV1NodeList) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1NodeList) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1NodeList) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
