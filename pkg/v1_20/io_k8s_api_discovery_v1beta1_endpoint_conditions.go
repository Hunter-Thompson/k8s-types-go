...
type IoK8sAPIDiscoveryV1beta1EndpointConditions struct {
	...
	Ready bool `json:"ready,omitempty" json,yaml:"ready,omitempty"`

	// serving is identical to ready except that it is set regardless of the terminating state of endpoints. This condition should be set to true for a ready endpoint that is terminating. If nil, consumers should defer to the ready condition. This field can be enabled with the EndpointSliceTerminatingCondition feature gate.
	Serving bool `json:"serving,omitempty" json,yaml:"serving,omitempty"`

	// terminating indicates that this endpoint is terminating. A nil value indicates an unknown state. Consumers should interpret this unknown state to mean that the endpoint is not terminating. This field can be enabled with the EndpointSliceTerminatingCondition feature gate.
	Terminating bool `json:"terminating,omitempty" json,yaml:"terminating,omitempty"`
}
...
// ContextValidate validates this io k8s api discovery v1beta1 endpoint conditions based on context it is used
func (m *IoK8sAPIDiscoveryV1beta1EndpointConditions) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
