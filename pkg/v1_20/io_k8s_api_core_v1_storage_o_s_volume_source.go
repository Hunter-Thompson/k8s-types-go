...
// ContextValidate validate this io k8s api core v1 storage o s volume source based on the context it is used
func (m *IoK8sAPICoreV1StorageOSVolumeSource) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1StorageOSVolumeSource) contextValidateSecretRef(ctx context.Context, formats strfmt.Registry) error {
