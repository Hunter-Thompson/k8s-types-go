...
type IoK8sAPICoreV1ObjectReference struct {
	...
	FieldPath string `json:"fieldPath,omitempty" json,yaml:"fieldPath,omitempty"`
...
// ContextValidate validates this io k8s api core v1 object reference based on context it is used
func (m *IoK8sAPICoreV1ObjectReference) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
