...
type IoK8sAPIRbacV1ClusterRoleBinding struct {
	...
	// Required: true
	RoleRef *IoK8sAPIRbacV1RoleRef `json:"roleRef" json,yaml:"roleRef"`

	// Subjects holds references to the objects the role applies to.
	Subjects []*IoK8sAPIRbacV1Subject `json:"subjects" json,yaml:"subjects"`
}
...
// ContextValidate validate this io k8s api rbac v1 cluster role binding based on the context it is used
func (m *IoK8sAPIRbacV1ClusterRoleBinding) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIRbacV1ClusterRoleBinding) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1ClusterRoleBinding) contextValidateRoleRef(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1ClusterRoleBinding) contextValidateSubjects(ctx context.Context, formats strfmt.Registry) error {
