...
// ContextValidate validate this io k8s api apps v1 daemon set condition based on the context it is used
func (m *IoK8sAPIAppsV1DaemonSetCondition) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAppsV1DaemonSetCondition) contextValidateLastTransitionTime(ctx context.Context, formats strfmt.Registry) error {
