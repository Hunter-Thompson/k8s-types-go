...
// ContextValidate validate this io k8s api apps v1 stateful set status based on the context it is used
func (m *IoK8sAPIAppsV1StatefulSetStatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAppsV1StatefulSetStatus) contextValidateConditions(ctx context.Context, formats strfmt.Registry) error {
