...
// ContextValidate validate this io k8s apiextensions apiserver pkg apis apiextensions v1 custom resource definition based on the context it is used
func (m *IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition) contextValidateSpec(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
