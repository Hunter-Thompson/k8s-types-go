...
// ContextValidate validates this io k8s api admissionregistration v1beta1 service reference based on context it is used
func (m *IoK8sAPIAdmissionregistrationV1beta1ServiceReference) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
