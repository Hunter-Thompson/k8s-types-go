...
type IoK8sAPINetworkingV1IngressSpec struct {
	...
	DefaultBackend *IoK8sAPINetworkingV1IngressBackend `json:"defaultBackend,omitempty" json,yaml:"defaultBackend,omitempty"`
	...
	Rules []*IoK8sAPINetworkingV1IngressRule `json:"rules" json,yaml:"rules"`

	// TLS configuration. Currently the Ingress only supports a single TLS port, 443. If multiple members of this list specify different hosts, they will be multiplexed on the same port according to the hostname specified through the SNI TLS extension, if the ingress controller fulfilling the ingress supports SNI.
	TLS []*IoK8sAPINetworkingV1IngressTLS `json:"tls" json,yaml:"tls"`
}
...
// ContextValidate validate this io k8s api networking v1 ingress spec based on the context it is used
func (m *IoK8sAPINetworkingV1IngressSpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPINetworkingV1IngressSpec) contextValidateDefaultBackend(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPINetworkingV1IngressSpec) contextValidateRules(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPINetworkingV1IngressSpec) contextValidateTLS(ctx context.Context, formats strfmt.Registry) error {
