...
var ioK8sApiCoreV1ServicePortTypeProtocolPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		ioK8sApiCoreV1ServicePortTypeProtocolPropEnum = append(ioK8sApiCoreV1ServicePortTypeProtocolPropEnum, v)
	}
}

const (

	// IoK8sAPICoreV1ServicePortProtocolSCTP captures enum value "SCTP"
	IoK8sAPICoreV1ServicePortProtocolSCTP string = "SCTP"

	// IoK8sAPICoreV1ServicePortProtocolTCP captures enum value "TCP"
	IoK8sAPICoreV1ServicePortProtocolTCP string = "TCP"

	// IoK8sAPICoreV1ServicePortProtocolUDP captures enum value "UDP"
	IoK8sAPICoreV1ServicePortProtocolUDP string = "UDP"
)

// prop value enum
func (m *IoK8sAPICoreV1ServicePort) validateProtocolEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, ioK8sApiCoreV1ServicePortTypeProtocolPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *IoK8sAPICoreV1ServicePort) validateProtocol(formats strfmt.Registry) error {
