...
type IoK8sAPICoreV1Namespace struct {
	...
	Spec *IoK8sAPICoreV1NamespaceSpec `json:"spec,omitempty" json,yaml:"spec,omitempty"`

	// Status describes the current status of a Namespace. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
	Status *IoK8sAPICoreV1NamespaceStatus `json:"status,omitempty" json,yaml:"status,omitempty"`
}
...
// ContextValidate validate this io k8s api core v1 namespace based on the context it is used
func (m *IoK8sAPICoreV1Namespace) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1Namespace) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1Namespace) contextValidateSpec(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1Namespace) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
