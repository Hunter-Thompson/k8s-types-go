...
type IoK8sAPIBatchV2alpha1CronJobSpec struct {
	...
	// Required: true
	JobTemplate *IoK8sAPIBatchV2alpha1JobTemplateSpec `json:"jobTemplate" json,yaml:"jobTemplate"`
...
// ContextValidate validate this io k8s api batch v2alpha1 cron job spec based on the context it is used
func (m *IoK8sAPIBatchV2alpha1CronJobSpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIBatchV2alpha1CronJobSpec) contextValidateJobTemplate(ctx context.Context, formats strfmt.Registry) error {
