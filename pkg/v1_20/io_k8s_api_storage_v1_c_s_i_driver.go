...
type IoK8sAPIStorageV1CSIDriver struct {
	...
	// Required: true
	Spec *IoK8sAPIStorageV1CSIDriverSpec `json:"spec" json,yaml:"spec"`
}
...
// ContextValidate validate this io k8s api storage v1 c s i driver based on the context it is used
func (m *IoK8sAPIStorageV1CSIDriver) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIStorageV1CSIDriver) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIStorageV1CSIDriver) contextValidateSpec(ctx context.Context, formats strfmt.Registry) error {
