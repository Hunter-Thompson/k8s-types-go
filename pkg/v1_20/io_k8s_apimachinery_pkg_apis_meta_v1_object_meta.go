...
type IoK8sApimachineryPkgApisMetaV1ObjectMeta struct {
	...
	Annotations map[string]string `json:"annotations,omitempty" json,yaml:"annotations,omitempty"`

	// The name of the cluster which the object belongs to. This is used to distinguish resources with same name and namespace in different clusters. This field is not set anywhere right now and apiserver is going to ignore it if set in create or update request.
	ClusterName string `json:"clusterName,omitempty" json,yaml:"clusterName,omitempty"`

	// CreationTimestamp is a timestamp representing the server time when this object was created. It is not guaranteed to be set in happens-before order across separate operations. Clients may not set this value. It is represented in RFC3339 form and is in UTC.
	//
	// Populated by the system. Read-only. Null for lists. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
	// Format: date-time
	CreationTimestamp IoK8sApimachineryPkgApisMetaV1Time `json:"creationTimestamp,omitempty" json,yaml:"creationTimestamp,omitempty"`

	// Number of seconds allowed for this object to gracefully terminate before it will be removed from the system. Only set when deletionTimestamp is also set. May only be shortened. Read-only.
	DeletionGracePeriodSeconds int64 `json:"deletionGracePeriodSeconds,omitempty" json,yaml:"deletionGracePeriodSeconds,omitempty"`
	...
	// Format: date-time
	DeletionTimestamp IoK8sApimachineryPkgApisMetaV1Time `json:"deletionTimestamp,omitempty" json,yaml:"deletionTimestamp,omitempty"`
	...
	GenerateName string `json:"generateName,omitempty" json,yaml:"generateName,omitempty"`

	// A sequence number representing a specific generation of the desired state. Populated by the system. Read-only.
	Generation int64 `json:"generation,omitempty" json,yaml:"generation,omitempty"`

	// Map of string keys and values that can be used to organize and categorize (scope and select) objects. May match selectors of replication controllers and services. More info: http://kubernetes.io/docs/user-guide/labels
	Labels map[string]string `json:"labels,omitempty" json,yaml:"labels,omitempty"`

	// ManagedFields maps workflow-id and version to the set of fields that are managed by that workflow. This is mostly for internal housekeeping, and users typically shouldn't need to set or understand this field. A workflow can be the user's name, a controller's name, or the name of a specific apply path like "ci-cd". The set of fields is always in the version that the workflow used when modifying the object.
	ManagedFields []*IoK8sApimachineryPkgApisMetaV1ManagedFieldsEntry `json:"managedFields" json,yaml:"managedFields"`
	...
	OwnerReferences []*IoK8sApimachineryPkgApisMetaV1OwnerReference `json:"ownerReferences" json,yaml:"ownerReferences"`
	...
	SelfLink string `json:"selfLink,omitempty" json,yaml:"selfLink,omitempty"`
...
// ContextValidate validate this io k8s apimachinery pkg apis meta v1 object meta based on the context it is used
func (m *IoK8sApimachineryPkgApisMetaV1ObjectMeta) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sApimachineryPkgApisMetaV1ObjectMeta) contextValidateCreationTimestamp(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sApimachineryPkgApisMetaV1ObjectMeta) contextValidateDeletionTimestamp(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sApimachineryPkgApisMetaV1ObjectMeta) contextValidateManagedFields(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sApimachineryPkgApisMetaV1ObjectMeta) contextValidateOwnerReferences(ctx context.Context, formats strfmt.Registry) error {
