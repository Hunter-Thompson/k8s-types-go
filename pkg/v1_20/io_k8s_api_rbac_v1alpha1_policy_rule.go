...
// ContextValidate validates this io k8s api rbac v1alpha1 policy rule based on context it is used
func (m *IoK8sAPIRbacV1alpha1PolicyRule) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
