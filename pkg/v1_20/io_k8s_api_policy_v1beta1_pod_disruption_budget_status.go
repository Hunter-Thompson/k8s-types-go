...
// ContextValidate validate this io k8s api policy v1beta1 pod disruption budget status based on the context it is used
...
func (m *IoK8sAPIPolicyV1beta1PodDisruptionBudgetStatus) contextValidateDisruptedPods(ctx context.Context, formats strfmt.Registry) error {
