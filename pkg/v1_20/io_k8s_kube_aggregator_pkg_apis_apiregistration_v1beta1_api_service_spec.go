...
type IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIServiceSpec struct {
	...
	// Required: true
	GroupPriorityMinimum *int32 `json:"groupPriorityMinimum" json,yaml:"groupPriorityMinimum"`

	// InsecureSkipTLSVerify disables TLS certificate verification when communicating with this server. This is strongly discouraged.  You should use the CABundle instead.
	InsecureSkipTLSVerify bool `json:"insecureSkipTLSVerify,omitempty" json,yaml:"insecureSkipTLSVerify,omitempty"`

	// Service is a reference to the service for this API server.  It must communicate on port 443. If the Service is nil, that means the handling for the API groupversion is handled locally on this server. The call will simply delegate to the normal handler chain to be fulfilled.
	Service *IoK8sKubeAggregatorPkgApisApiregistrationV1beta1ServiceReference `json:"service,omitempty" json,yaml:"service,omitempty"`
	...
	// Required: true
	VersionPriority *int32 `json:"versionPriority" json,yaml:"versionPriority"`
}
...
// ContextValidate validate this io k8s kube aggregator pkg apis apiregistration v1beta1 API service spec based on the context it is used
func (m *IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIServiceSpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIServiceSpec) contextValidateService(ctx context.Context, formats strfmt.Registry) error {
