...
// ContextValidate validates this io k8s api authorization v1 subject access review status based on context it is used
func (m *IoK8sAPIAuthorizationV1SubjectAccessReviewStatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
