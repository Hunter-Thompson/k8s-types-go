...
// ContextValidate validates this io k8s api core v1 client IP config based on context it is used
func (m *IoK8sAPICoreV1ClientIPConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
