...
type IoK8sAPICoreV1GCEPersistentDiskVolumeSource struct {
	...
	// Required: true
	PdName *string `json:"pdName" json,yaml:"pdName"`
...
// ContextValidate validates this io k8s api core v1 g c e persistent disk volume source based on context it is used
func (m *IoK8sAPICoreV1GCEPersistentDiskVolumeSource) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
