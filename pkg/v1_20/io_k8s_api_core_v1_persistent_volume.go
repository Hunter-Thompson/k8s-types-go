...
type IoK8sAPICoreV1PersistentVolume struct {
	...
	Spec *IoK8sAPICoreV1PersistentVolumeSpec `json:"spec,omitempty" json,yaml:"spec,omitempty"`

	// Status represents the current information/status for the persistent volume. Populated by the system. Read-only. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistent-volumes
	Status *IoK8sAPICoreV1PersistentVolumeStatus `json:"status,omitempty" json,yaml:"status,omitempty"`
}
...
// ContextValidate validate this io k8s api core v1 persistent volume based on the context it is used
func (m *IoK8sAPICoreV1PersistentVolume) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1PersistentVolume) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1PersistentVolume) contextValidateSpec(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1PersistentVolume) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
