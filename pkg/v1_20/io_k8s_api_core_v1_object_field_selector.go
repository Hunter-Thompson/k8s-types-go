...
// ContextValidate validates this io k8s api core v1 object field selector based on context it is used
func (m *IoK8sAPICoreV1ObjectFieldSelector) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
