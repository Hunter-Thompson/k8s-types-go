...
type IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceDefinitionStatus struct {
	...
	AcceptedNames *IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceDefinitionNames `json:"acceptedNames,omitempty" json,yaml:"acceptedNames,omitempty"`

	// conditions indicate state for particular aspects of a CustomResourceDefinition
	Conditions []*IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceDefinitionCondition `json:"conditions" json,yaml:"conditions"`
...
// ContextValidate validate this io k8s apiextensions apiserver pkg apis apiextensions v1beta1 custom resource definition status based on the context it is used
func (m *IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceDefinitionStatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceDefinitionStatus) contextValidateAcceptedNames(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceDefinitionStatus) contextValidateConditions(ctx context.Context, formats strfmt.Registry) error {
