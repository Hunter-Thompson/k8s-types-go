...
type IoK8sAPIExtensionsV1beta1HTTPIngressRuleValue struct {
	...
	// Required: true
	Paths []*IoK8sAPIExtensionsV1beta1HTTPIngressPath `json:"paths" json,yaml:"paths"`
}
...
// ContextValidate validate this io k8s api extensions v1beta1 HTTP ingress rule value based on the context it is used
func (m *IoK8sAPIExtensionsV1beta1HTTPIngressRuleValue) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIExtensionsV1beta1HTTPIngressRuleValue) contextValidatePaths(ctx context.Context, formats strfmt.Registry) error {
