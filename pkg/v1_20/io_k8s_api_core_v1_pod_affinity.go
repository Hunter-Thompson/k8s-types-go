...
// ContextValidate validate this io k8s api core v1 pod affinity based on the context it is used
func (m *IoK8sAPICoreV1PodAffinity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1PodAffinity) contextValidatePreferredDuringSchedulingIgnoredDuringExecution(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1PodAffinity) contextValidateRequiredDuringSchedulingIgnoredDuringExecution(ctx context.Context, formats strfmt.Registry) error {
