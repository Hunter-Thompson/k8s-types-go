...
type IoK8sAPICoreV1ConfigMap struct {
	...
	BinaryData map[string]strfmt.Base64 `json:"binaryData,omitempty" json,yaml:"binaryData,omitempty"`

	// Data contains the configuration data. Each key must consist of alphanumeric characters, '-', '_' or '.'. Values with non-UTF-8 byte sequences must use the BinaryData field. The keys stored in Data must not overlap with the keys in the BinaryData field, this is enforced during validation process.
	Data map[string]string `json:"data,omitempty" json,yaml:"data,omitempty"`
...
// ContextValidate validate this io k8s api core v1 config map based on the context it is used
func (m *IoK8sAPICoreV1ConfigMap) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1ConfigMap) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
