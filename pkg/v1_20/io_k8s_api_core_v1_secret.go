...
// ContextValidate validate this io k8s api core v1 secret based on the context it is used
func (m *IoK8sAPICoreV1Secret) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1Secret) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
