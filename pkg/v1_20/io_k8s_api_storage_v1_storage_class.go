...
// ContextValidate validate this io k8s api storage v1 storage class based on the context it is used
func (m *IoK8sAPIStorageV1StorageClass) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIStorageV1StorageClass) contextValidateAllowedTopologies(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIStorageV1StorageClass) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
