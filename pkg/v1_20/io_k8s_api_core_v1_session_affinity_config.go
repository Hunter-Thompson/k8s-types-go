...
// ContextValidate validate this io k8s api core v1 session affinity config based on the context it is used
func (m *IoK8sAPICoreV1SessionAffinityConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1SessionAffinityConfig) contextValidateClientIP(ctx context.Context, formats strfmt.Registry) error {
