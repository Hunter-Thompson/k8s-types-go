...
// ContextValidate validate this io k8s api core v1 event series based on the context it is used
func (m *IoK8sAPICoreV1EventSeries) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1EventSeries) contextValidateLastObservedTime(ctx context.Context, formats strfmt.Registry) error {
