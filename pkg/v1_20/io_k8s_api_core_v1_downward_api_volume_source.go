...
// ContextValidate validate this io k8s api core v1 downward API volume source based on the context it is used
func (m *IoK8sAPICoreV1DownwardAPIVolumeSource) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1DownwardAPIVolumeSource) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
