...
// ContextValidate validate this io k8s api autoscaling v2beta2 metric target based on the context it is used
func (m *IoK8sAPIAutoscalingV2beta2MetricTarget) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAutoscalingV2beta2MetricTarget) contextValidateAverageValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIAutoscalingV2beta2MetricTarget) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
