...
type IoK8sAPINetworkingV1NetworkPolicySpec struct {
	...
	Egress []*IoK8sAPINetworkingV1NetworkPolicyEgressRule `json:"egress" json,yaml:"egress"`

	// List of ingress rules to be applied to the selected pods. Traffic is allowed to a pod if there are no NetworkPolicies selecting the pod (and cluster policy otherwise allows the traffic), OR if the traffic source is the pod's local node, OR if the traffic matches at least one ingress rule across all of the NetworkPolicy objects whose podSelector matches the pod. If this field is empty then this NetworkPolicy does not allow any traffic (and serves solely to ensure that the pods it selects are isolated by default)
	Ingress []*IoK8sAPINetworkingV1NetworkPolicyIngressRule `json:"ingress" json,yaml:"ingress"`

	// Selects the pods to which this NetworkPolicy object applies. The array of ingress rules is applied to any pods selected by this field. Multiple network policies can select the same set of pods. In this case, the ingress rules for each are combined additively. This field is NOT optional and follows standard label selector semantics. An empty podSelector matches all pods in this namespace.
	// Required: true
	PodSelector *IoK8sApimachineryPkgApisMetaV1LabelSelector `json:"podSelector" json,yaml:"podSelector"`
	...
	PolicyTypes []string `json:"policyTypes" json,yaml:"policyTypes"`
}
...
// ContextValidate validate this io k8s api networking v1 network policy spec based on the context it is used
func (m *IoK8sAPINetworkingV1NetworkPolicySpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPINetworkingV1NetworkPolicySpec) contextValidateEgress(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPINetworkingV1NetworkPolicySpec) contextValidateIngress(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPINetworkingV1NetworkPolicySpec) contextValidatePodSelector(ctx context.Context, formats strfmt.Registry) error {
