...
type IoK8sAPIFlowcontrolV1alpha1PriorityLevelConfigurationList struct {
	...
	// Required: true
	Items []*IoK8sAPIFlowcontrolV1alpha1PriorityLevelConfiguration `json:"items" json,yaml:"items"`
...
// ContextValidate validate this io k8s api flowcontrol v1alpha1 priority level configuration list based on the context it is used
func (m *IoK8sAPIFlowcontrolV1alpha1PriorityLevelConfigurationList) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIFlowcontrolV1alpha1PriorityLevelConfigurationList) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIFlowcontrolV1alpha1PriorityLevelConfigurationList) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
