...
// ContextValidate validate this io k8s api storage v1 volume error based on the context it is used
func (m *IoK8sAPIStorageV1VolumeError) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIStorageV1VolumeError) contextValidateTime(ctx context.Context, formats strfmt.Registry) error {
