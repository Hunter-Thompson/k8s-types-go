...
// ContextValidate validates this io k8s kube aggregator pkg apis apiregistration v1 service reference based on context it is used
func (m *IoK8sKubeAggregatorPkgApisApiregistrationV1ServiceReference) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
