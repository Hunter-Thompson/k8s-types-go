...
type IoK8sAPICoreV1Binding struct {
	...
	// Required: true
	Target *IoK8sAPICoreV1ObjectReference `json:"target" json,yaml:"target"`
}
...
// ContextValidate validate this io k8s api core v1 binding based on the context it is used
func (m *IoK8sAPICoreV1Binding) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1Binding) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1Binding) contextValidateTarget(ctx context.Context, formats strfmt.Registry) error {
