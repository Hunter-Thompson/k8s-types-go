...
// ContextValidate validate this io k8s api flowcontrol v1alpha1 flow schema condition based on the context it is used
func (m *IoK8sAPIFlowcontrolV1alpha1FlowSchemaCondition) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIFlowcontrolV1alpha1FlowSchemaCondition) contextValidateLastTransitionTime(ctx context.Context, formats strfmt.Registry) error {
