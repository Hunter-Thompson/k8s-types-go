...
// ContextValidate validate this io k8s api core v1 node daemon endpoints based on the context it is used
func (m *IoK8sAPICoreV1NodeDaemonEndpoints) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1NodeDaemonEndpoints) contextValidateKubeletEndpoint(ctx context.Context, formats strfmt.Registry) error {
