...
// ContextValidate validate this io k8s api events v1 event based on the context it is used
func (m *IoK8sAPIEventsV1Event) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIEventsV1Event) contextValidateDeprecatedFirstTimestamp(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIEventsV1Event) contextValidateDeprecatedLastTimestamp(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIEventsV1Event) contextValidateDeprecatedSource(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIEventsV1Event) contextValidateEventTime(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIEventsV1Event) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIEventsV1Event) contextValidateRegarding(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIEventsV1Event) contextValidateRelated(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIEventsV1Event) contextValidateSeries(ctx context.Context, formats strfmt.Registry) error {
