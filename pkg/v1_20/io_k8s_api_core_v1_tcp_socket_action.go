...
// ContextValidate validate this io k8s api core v1 TCP socket action based on the context it is used
func (m *IoK8sAPICoreV1TCPSocketAction) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1TCPSocketAction) contextValidatePort(ctx context.Context, formats strfmt.Registry) error {
