...
type IoK8sAPIAutoscalingV2beta2HorizontalPodAutoscalerStatus struct {
	...
	// Required: true
	Conditions []*IoK8sAPIAutoscalingV2beta2HorizontalPodAutoscalerCondition `json:"conditions" json,yaml:"conditions"`

	// currentMetrics is the last read state of the metrics used by this autoscaler.
	CurrentMetrics []*IoK8sAPIAutoscalingV2beta2MetricStatus `json:"currentMetrics" json,yaml:"currentMetrics"`
...
// ContextValidate validate this io k8s api autoscaling v2beta2 horizontal pod autoscaler status based on the context it is used
func (m *IoK8sAPIAutoscalingV2beta2HorizontalPodAutoscalerStatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAutoscalingV2beta2HorizontalPodAutoscalerStatus) contextValidateConditions(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIAutoscalingV2beta2HorizontalPodAutoscalerStatus) contextValidateCurrentMetrics(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIAutoscalingV2beta2HorizontalPodAutoscalerStatus) contextValidateLastScaleTime(ctx context.Context, formats strfmt.Registry) error {
