...
// ContextValidate validate this io k8s api rbac v1alpha1 role binding based on the context it is used
func (m *IoK8sAPIRbacV1alpha1RoleBinding) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIRbacV1alpha1RoleBinding) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1alpha1RoleBinding) contextValidateRoleRef(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1alpha1RoleBinding) contextValidateSubjects(ctx context.Context, formats strfmt.Registry) error {
