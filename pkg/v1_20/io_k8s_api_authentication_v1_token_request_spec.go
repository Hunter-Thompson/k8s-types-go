...
type IoK8sAPIAuthenticationV1TokenRequestSpec struct {
	...
	BoundObjectRef *IoK8sAPIAuthenticationV1BoundObjectReference `json:"boundObjectRef,omitempty" json,yaml:"boundObjectRef,omitempty"`
	...
	if m.BoundObjectRef != nil {
		if err := m.BoundObjectRef.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("boundObjectRef")
			}
			return err
		}
	}
...
// ContextValidate validate this io k8s api authentication v1 token request spec based on the context it is used
func (m *IoK8sAPIAuthenticationV1TokenRequestSpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error

	if err := m.contextValidateBoundObjectRef(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *IoK8sAPIAuthenticationV1TokenRequestSpec) contextValidateBoundObjectRef(ctx context.Context, formats strfmt.Registry) error {

	if m.BoundObjectRef != nil {
		if err := m.BoundObjectRef.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("boundObjectRef")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("boundObjectRef")
