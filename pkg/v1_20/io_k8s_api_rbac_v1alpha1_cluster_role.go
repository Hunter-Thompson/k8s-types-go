...
type IoK8sAPIRbacV1alpha1ClusterRole struct {
	...
	AggregationRule *IoK8sAPIRbacV1alpha1AggregationRule `json:"aggregationRule,omitempty" json,yaml:"aggregationRule,omitempty"`
	...
	Rules []*IoK8sAPIRbacV1alpha1PolicyRule `json:"rules" json,yaml:"rules"`
}
...
// ContextValidate validate this io k8s api rbac v1alpha1 cluster role based on the context it is used
func (m *IoK8sAPIRbacV1alpha1ClusterRole) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIRbacV1alpha1ClusterRole) contextValidateAggregationRule(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1alpha1ClusterRole) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1alpha1ClusterRole) contextValidateRules(ctx context.Context, formats strfmt.Registry) error {
