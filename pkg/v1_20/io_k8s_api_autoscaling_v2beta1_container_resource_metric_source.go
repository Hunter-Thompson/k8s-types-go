...
//
// swagger:model io.k8s.api.autoscaling.v2beta1.ContainerResourceMetricSource
...
func (m *IoK8sAPIAutoscalingV2beta1ContainerResourceMetricSource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAutoscalingV2beta1ContainerResourceMetricSource) validateContainer(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAutoscalingV2beta1ContainerResourceMetricSource) validateName(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAutoscalingV2beta1ContainerResourceMetricSource) validateTargetAverageValue(formats strfmt.Registry) error {
...
// ContextValidate validate this io k8s api autoscaling v2beta1 container resource metric source based on the context it is used
func (m *IoK8sAPIAutoscalingV2beta1ContainerResourceMetricSource) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAutoscalingV2beta1ContainerResourceMetricSource) contextValidateTargetAverageValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIAutoscalingV2beta1ContainerResourceMetricSource) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *IoK8sAPIAutoscalingV2beta1ContainerResourceMetricSource) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIAutoscalingV2beta1ContainerResourceMetricSource
