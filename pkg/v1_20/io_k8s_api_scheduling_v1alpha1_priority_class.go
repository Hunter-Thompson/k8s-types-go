...
type IoK8sAPISchedulingV1alpha1PriorityClass struct {
	...
	GlobalDefault bool `json:"globalDefault,omitempty" json,yaml:"globalDefault,omitempty"`
...
// ContextValidate validate this io k8s api scheduling v1alpha1 priority class based on the context it is used
func (m *IoK8sAPISchedulingV1alpha1PriorityClass) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPISchedulingV1alpha1PriorityClass) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
