...
// ContextValidate validates this io k8s api flowcontrol v1alpha1 group subject based on context it is used
func (m *IoK8sAPIFlowcontrolV1alpha1GroupSubject) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
