...
type IoK8sAPIFlowcontrolV1alpha1LimitedPriorityLevelConfiguration struct {
	...
	LimitResponse *IoK8sAPIFlowcontrolV1alpha1LimitResponse `json:"limitResponse,omitempty" json,yaml:"limitResponse,omitempty"`
}
...
// ContextValidate validate this io k8s api flowcontrol v1alpha1 limited priority level configuration based on the context it is used
func (m *IoK8sAPIFlowcontrolV1alpha1LimitedPriorityLevelConfiguration) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIFlowcontrolV1alpha1LimitedPriorityLevelConfiguration) contextValidateLimitResponse(ctx context.Context, formats strfmt.Registry) error {
