...
type IoK8sAPIFlowcontrolV1alpha1PriorityLevelConfigurationSpec struct {
	...
	Limited *IoK8sAPIFlowcontrolV1alpha1LimitedPriorityLevelConfiguration `json:"limited,omitempty" json,yaml:"limited,omitempty"`
...
// ContextValidate validate this io k8s api flowcontrol v1alpha1 priority level configuration spec based on the context it is used
func (m *IoK8sAPIFlowcontrolV1alpha1PriorityLevelConfigurationSpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIFlowcontrolV1alpha1PriorityLevelConfigurationSpec) contextValidateLimited(ctx context.Context, formats strfmt.Registry) error {
