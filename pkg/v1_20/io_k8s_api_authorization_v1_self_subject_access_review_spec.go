...
// ContextValidate validate this io k8s api authorization v1 self subject access review spec based on the context it is used
func (m *IoK8sAPIAuthorizationV1SelfSubjectAccessReviewSpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAuthorizationV1SelfSubjectAccessReviewSpec) contextValidateNonResourceAttributes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIAuthorizationV1SelfSubjectAccessReviewSpec) contextValidateResourceAttributes(ctx context.Context, formats strfmt.Registry) error {
