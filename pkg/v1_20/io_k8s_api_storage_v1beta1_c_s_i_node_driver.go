...
type IoK8sAPIStorageV1beta1CSINodeDriver struct {
	...
	Allocatable *IoK8sAPIStorageV1beta1VolumeNodeResources `json:"allocatable,omitempty" json,yaml:"allocatable,omitempty"`
	...
	// Required: true
	NodeID *string `json:"nodeID" json,yaml:"nodeID"`
...
// ContextValidate validate this io k8s api storage v1beta1 c s i node driver based on the context it is used
func (m *IoK8sAPIStorageV1beta1CSINodeDriver) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIStorageV1beta1CSINodeDriver) contextValidateAllocatable(ctx context.Context, formats strfmt.Registry) error {
