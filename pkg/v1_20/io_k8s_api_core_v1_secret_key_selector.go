...
// ContextValidate validates this io k8s api core v1 secret key selector based on context it is used
func (m *IoK8sAPICoreV1SecretKeySelector) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
