...
type IoK8sAPIRbacV1beta1ClusterRoleBinding struct {
	...
	// Required: true
	RoleRef *IoK8sAPIRbacV1beta1RoleRef `json:"roleRef" json,yaml:"roleRef"`

	// Subjects holds references to the objects the role applies to.
	Subjects []*IoK8sAPIRbacV1beta1Subject `json:"subjects" json,yaml:"subjects"`
}
...
// ContextValidate validate this io k8s api rbac v1beta1 cluster role binding based on the context it is used
func (m *IoK8sAPIRbacV1beta1ClusterRoleBinding) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIRbacV1beta1ClusterRoleBinding) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1beta1ClusterRoleBinding) contextValidateRoleRef(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1beta1ClusterRoleBinding) contextValidateSubjects(ctx context.Context, formats strfmt.Registry) error {
