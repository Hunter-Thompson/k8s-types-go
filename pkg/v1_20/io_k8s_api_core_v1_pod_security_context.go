...
type IoK8sAPICoreV1PodSecurityContext struct {
	...
	FsGroup int64 `json:"fsGroup,omitempty" json,yaml:"fsGroup,omitempty"`

	// fsGroupChangePolicy defines behavior of changing ownership and permission of the volume before being exposed inside Pod. This field will only apply to volume types which support fsGroup based ownership(and permissions). It will have no effect on ephemeral volume types such as: secret, configmaps and emptydir. Valid values are "OnRootMismatch" and "Always". If not specified, "Always" is used.
	FsGroupChangePolicy string `json:"fsGroupChangePolicy,omitempty" json,yaml:"fsGroupChangePolicy,omitempty"`
	...
	SupplementalGroups []int64 `json:"supplementalGroups" json,yaml:"supplementalGroups"`

	// Sysctls hold a list of namespaced sysctls used for the pod. Pods with unsupported sysctls (by the container runtime) might fail to launch.
	Sysctls []*IoK8sAPICoreV1Sysctl `json:"sysctls" json,yaml:"sysctls"`
