...
type IoK8sAPICoreV1NodeSystemInfo struct {
	...
	// Required: true
	Architecture *string `json:"architecture" json,yaml:"architecture"`

	// Boot ID reported by the node.
	// Required: true
	BootID *string `json:"bootID" json,yaml:"bootID"`

	// ContainerRuntime Version reported by the node through runtime remote API (e.g. docker://1.5.0).
	// Required: true
	ContainerRuntimeVersion *string `json:"containerRuntimeVersion" json,yaml:"containerRuntimeVersion"`

	// Kernel Version reported by the node from 'uname -r' (e.g. 3.16.0-0.bpo.4-amd64).
	// Required: true
	KernelVersion *string `json:"kernelVersion" json,yaml:"kernelVersion"`

	// KubeProxy Version reported by the node.
	// Required: true
	KubeProxyVersion *string `json:"kubeProxyVersion" json,yaml:"kubeProxyVersion"`

	// Kubelet Version reported by the node.
	// Required: true
	KubeletVersion *string `json:"kubeletVersion" json,yaml:"kubeletVersion"`

	// MachineID reported by the node. For unique machine identification in the cluster this field is preferred. Learn more from man(5) machine-id: http://man7.org/linux/man-pages/man5/machine-id.5.html
	// Required: true
	MachineID *string `json:"machineID" json,yaml:"machineID"`

	// The Operating System reported by the node
	// Required: true
	OperatingSystem *string `json:"operatingSystem" json,yaml:"operatingSystem"`

	// OS Image reported by the node from /etc/os-release (e.g. Debian GNU/Linux 7 (wheezy)).
	// Required: true
	OsImage *string `json:"osImage" json,yaml:"osImage"`

	// SystemUUID reported by the node. For unique machine identification MachineID is preferred. This field is specific to Red Hat hosts https://access.redhat.com/documentation/en-us/red_hat_subscription_management/1/html/rhsm/uuid
	// Required: true
	SystemUUID *string `json:"systemUUID" json,yaml:"systemUUID"`
}
...
// ContextValidate validates this io k8s api core v1 node system info based on context it is used
func (m *IoK8sAPICoreV1NodeSystemInfo) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
