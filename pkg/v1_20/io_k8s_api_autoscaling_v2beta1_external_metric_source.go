...
// ContextValidate validate this io k8s api autoscaling v2beta1 external metric source based on the context it is used
func (m *IoK8sAPIAutoscalingV2beta1ExternalMetricSource) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAutoscalingV2beta1ExternalMetricSource) contextValidateMetricSelector(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIAutoscalingV2beta1ExternalMetricSource) contextValidateTargetAverageValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIAutoscalingV2beta1ExternalMetricSource) contextValidateTargetValue(ctx context.Context, formats strfmt.Registry) error {
