...
// ContextValidate validate this io k8s api rbac v1alpha1 role based on the context it is used
func (m *IoK8sAPIRbacV1alpha1Role) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIRbacV1alpha1Role) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1alpha1Role) contextValidateRules(ctx context.Context, formats strfmt.Registry) error {
