...
// ContextValidate validate this io k8s api core v1 i s c s i persistent volume source based on the context it is used
func (m *IoK8sAPICoreV1ISCSIPersistentVolumeSource) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1ISCSIPersistentVolumeSource) contextValidateSecretRef(ctx context.Context, formats strfmt.Registry) error {
