...
// ContextValidate validates this io k8s api authentication v1 token review spec based on context it is used
func (m *IoK8sAPIAuthenticationV1TokenReviewSpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
