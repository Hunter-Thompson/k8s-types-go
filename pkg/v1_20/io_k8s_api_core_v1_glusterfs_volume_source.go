...
// ContextValidate validates this io k8s api core v1 glusterfs volume source based on context it is used
func (m *IoK8sAPICoreV1GlusterfsVolumeSource) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
