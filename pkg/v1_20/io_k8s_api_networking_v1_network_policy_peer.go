...
// ContextValidate validate this io k8s api networking v1 network policy peer based on the context it is used
func (m *IoK8sAPINetworkingV1NetworkPolicyPeer) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPINetworkingV1NetworkPolicyPeer) contextValidateIPBlock(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPINetworkingV1NetworkPolicyPeer) contextValidateNamespaceSelector(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPINetworkingV1NetworkPolicyPeer) contextValidatePodSelector(ctx context.Context, formats strfmt.Registry) error {
