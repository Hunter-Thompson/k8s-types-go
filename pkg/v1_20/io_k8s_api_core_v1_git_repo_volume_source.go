...
// ContextValidate validates this io k8s api core v1 git repo volume source based on context it is used
func (m *IoK8sAPICoreV1GitRepoVolumeSource) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
