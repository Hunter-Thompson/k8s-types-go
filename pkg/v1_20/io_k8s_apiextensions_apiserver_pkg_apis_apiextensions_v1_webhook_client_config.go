...
type IoK8sApiextensionsApiserverPkgApisApiextensionsV1WebhookClientConfig struct {
	...
	Service *IoK8sApiextensionsApiserverPkgApisApiextensionsV1ServiceReference `json:"service,omitempty" json,yaml:"service,omitempty"`
...
// ContextValidate validate this io k8s apiextensions apiserver pkg apis apiextensions v1 webhook client config based on the context it is used
func (m *IoK8sApiextensionsApiserverPkgApisApiextensionsV1WebhookClientConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sApiextensionsApiserverPkgApisApiextensionsV1WebhookClientConfig) contextValidateService(ctx context.Context, formats strfmt.Registry) error {
