...
type IoK8sAPIAutoscalingV1Scale struct {
	...
	Spec *IoK8sAPIAutoscalingV1ScaleSpec `json:"spec,omitempty" json,yaml:"spec,omitempty"`

	// current status of the scale. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status. Read-only.
	Status *IoK8sAPIAutoscalingV1ScaleStatus `json:"status,omitempty" json,yaml:"status,omitempty"`
}
...
// ContextValidate validate this io k8s api autoscaling v1 scale based on the context it is used
func (m *IoK8sAPIAutoscalingV1Scale) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAutoscalingV1Scale) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIAutoscalingV1Scale) contextValidateSpec(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIAutoscalingV1Scale) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
