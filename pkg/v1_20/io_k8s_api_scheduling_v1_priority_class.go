...
// ContextValidate validate this io k8s api scheduling v1 priority class based on the context it is used
func (m *IoK8sAPISchedulingV1PriorityClass) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPISchedulingV1PriorityClass) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
