...
// ContextValidate validate this io k8s api storage v1 c s i node spec based on the context it is used
func (m *IoK8sAPIStorageV1CSINodeSpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIStorageV1CSINodeSpec) contextValidateDrivers(ctx context.Context, formats strfmt.Registry) error {
