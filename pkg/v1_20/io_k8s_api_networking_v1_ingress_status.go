...
// ContextValidate validate this io k8s api networking v1 ingress status based on the context it is used
func (m *IoK8sAPINetworkingV1IngressStatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPINetworkingV1IngressStatus) contextValidateLoadBalancer(ctx context.Context, formats strfmt.Registry) error {
