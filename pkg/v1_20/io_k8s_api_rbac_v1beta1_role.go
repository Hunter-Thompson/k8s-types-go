...
// ContextValidate validate this io k8s api rbac v1beta1 role based on the context it is used
func (m *IoK8sAPIRbacV1beta1Role) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIRbacV1beta1Role) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1beta1Role) contextValidateRules(ctx context.Context, formats strfmt.Registry) error {
