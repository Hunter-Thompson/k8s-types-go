...
// ContextValidate validates this io k8s apimachinery pkg api resource quantity based on context it is used
func (m IoK8sApimachineryPkgAPIResourceQuantity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
