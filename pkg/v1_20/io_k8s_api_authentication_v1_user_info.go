...
// ContextValidate validates this io k8s api authentication v1 user info based on context it is used
func (m *IoK8sAPIAuthenticationV1UserInfo) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
