...
// ContextValidate validate this io k8s api batch v1beta1 cron job spec based on the context it is used
func (m *IoK8sAPIBatchV1beta1CronJobSpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIBatchV1beta1CronJobSpec) contextValidateJobTemplate(ctx context.Context, formats strfmt.Registry) error {
