...
type IoK8sApimachineryPkgApisMetaV1ListMeta struct {
	...
	Continue string `json:"continue,omitempty" json,yaml:"continue,omitempty"`
	...
	RemainingItemCount int64 `json:"remainingItemCount,omitempty" json,yaml:"remainingItemCount,omitempty"`
