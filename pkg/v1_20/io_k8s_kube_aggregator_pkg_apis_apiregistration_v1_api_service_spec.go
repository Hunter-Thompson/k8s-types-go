...
type IoK8sKubeAggregatorPkgApisApiregistrationV1APIServiceSpec struct {
	...
	Service *IoK8sKubeAggregatorPkgApisApiregistrationV1ServiceReference `json:"service,omitempty" json,yaml:"service,omitempty"`
...
// ContextValidate validate this io k8s kube aggregator pkg apis apiregistration v1 API service spec based on the context it is used
func (m *IoK8sKubeAggregatorPkgApisApiregistrationV1APIServiceSpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sKubeAggregatorPkgApisApiregistrationV1APIServiceSpec) contextValidateService(ctx context.Context, formats strfmt.Registry) error {
