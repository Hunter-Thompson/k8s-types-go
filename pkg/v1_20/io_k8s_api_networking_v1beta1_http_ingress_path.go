...
type IoK8sAPINetworkingV1beta1HTTPIngressPath struct {
	...
	// Required: true
	Backend *IoK8sAPINetworkingV1beta1IngressBackend `json:"backend" json,yaml:"backend"`
...
// ContextValidate validate this io k8s api networking v1beta1 HTTP ingress path based on the context it is used
func (m *IoK8sAPINetworkingV1beta1HTTPIngressPath) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPINetworkingV1beta1HTTPIngressPath) contextValidateBackend(ctx context.Context, formats strfmt.Registry) error {
