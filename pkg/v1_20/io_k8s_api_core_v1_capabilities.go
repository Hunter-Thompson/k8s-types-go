...
// ContextValidate validates this io k8s api core v1 capabilities based on context it is used
func (m *IoK8sAPICoreV1Capabilities) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
