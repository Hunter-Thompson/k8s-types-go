...
// ContextValidate validate this io k8s api core v1 node condition based on the context it is used
func (m *IoK8sAPICoreV1NodeCondition) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1NodeCondition) contextValidateLastHeartbeatTime(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1NodeCondition) contextValidateLastTransitionTime(ctx context.Context, formats strfmt.Registry) error {
