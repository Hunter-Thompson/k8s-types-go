...
type IoK8sAPIAuthorizationV1beta1ResourceRule struct {
	...
	ResourceNames []string `json:"resourceNames" json,yaml:"resourceNames"`
...
// ContextValidate validates this io k8s api authorization v1beta1 resource rule based on context it is used
func (m *IoK8sAPIAuthorizationV1beta1ResourceRule) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
