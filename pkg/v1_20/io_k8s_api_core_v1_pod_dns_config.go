...
// ContextValidate validate this io k8s api core v1 pod DNS config based on the context it is used
func (m *IoK8sAPICoreV1PodDNSConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1PodDNSConfig) contextValidateOptions(ctx context.Context, formats strfmt.Registry) error {
