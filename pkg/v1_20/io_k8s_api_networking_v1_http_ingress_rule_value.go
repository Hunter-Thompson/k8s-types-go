...
// ContextValidate validate this io k8s api networking v1 HTTP ingress rule value based on the context it is used
func (m *IoK8sAPINetworkingV1HTTPIngressRuleValue) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPINetworkingV1HTTPIngressRuleValue) contextValidatePaths(ctx context.Context, formats strfmt.Registry) error {
