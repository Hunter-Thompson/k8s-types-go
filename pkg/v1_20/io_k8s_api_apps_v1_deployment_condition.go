...
// ContextValidate validate this io k8s api apps v1 deployment condition based on the context it is used
func (m *IoK8sAPIAppsV1DeploymentCondition) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAppsV1DeploymentCondition) contextValidateLastTransitionTime(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIAppsV1DeploymentCondition) contextValidateLastUpdateTime(ctx context.Context, formats strfmt.Registry) error {
