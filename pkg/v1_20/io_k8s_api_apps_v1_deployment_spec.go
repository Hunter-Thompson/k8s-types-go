...
type IoK8sAPIAppsV1DeploymentSpec struct {
	...
	Paused bool `json:"paused,omitempty" json,yaml:"paused,omitempty"`

	// The maximum time in seconds for a deployment to make progress before it is considered to be failed. The deployment controller will continue to process failed deployments and a condition with a ProgressDeadlineExceeded reason will be surfaced in the deployment status. Note that progress will not be estimated during the time a deployment is paused. Defaults to 600s.
	ProgressDeadlineSeconds int32 `json:"progressDeadlineSeconds,omitempty" json,yaml:"progressDeadlineSeconds,omitempty"`
	...
	Strategy *IoK8sAPIAppsV1DeploymentStrategy `json:"strategy,omitempty" json,yaml:"strategy,omitempty"`
...
// ContextValidate validate this io k8s api apps v1 deployment spec based on the context it is used
func (m *IoK8sAPIAppsV1DeploymentSpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAppsV1DeploymentSpec) contextValidateSelector(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIAppsV1DeploymentSpec) contextValidateStrategy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIAppsV1DeploymentSpec) contextValidateTemplate(ctx context.Context, formats strfmt.Registry) error {
