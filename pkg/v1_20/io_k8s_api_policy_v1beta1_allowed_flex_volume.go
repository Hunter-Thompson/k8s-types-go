...
// ContextValidate validates this io k8s api policy v1beta1 allowed flex volume based on context it is used
func (m *IoK8sAPIPolicyV1beta1AllowedFlexVolume) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
