...
type IoK8sAPIRbacV1beta1ClusterRoleList struct {
	...
	// Required: true
	Items []*IoK8sAPIRbacV1beta1ClusterRole `json:"items" json,yaml:"items"`
...
// ContextValidate validate this io k8s api rbac v1beta1 cluster role list based on the context it is used
func (m *IoK8sAPIRbacV1beta1ClusterRoleList) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIRbacV1beta1ClusterRoleList) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1beta1ClusterRoleList) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
