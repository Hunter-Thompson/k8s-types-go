...
// ContextValidate validate this io k8s api apps v1 daemon set status based on the context it is used
func (m *IoK8sAPIAppsV1DaemonSetStatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAppsV1DaemonSetStatus) contextValidateConditions(ctx context.Context, formats strfmt.Registry) error {
