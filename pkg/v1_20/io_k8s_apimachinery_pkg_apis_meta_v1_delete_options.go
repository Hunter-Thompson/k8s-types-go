...
type IoK8sApimachineryPkgApisMetaV1DeleteOptions struct {
	...
	DryRun []string `json:"dryRun" json,yaml:"dryRun"`

	// The duration in seconds before the object should be deleted. Value must be non-negative integer. The value zero indicates delete immediately. If this value is nil, the default grace period for the specified type will be used. Defaults to a per object value if not specified. zero means delete immediately.
	GracePeriodSeconds int64 `json:"gracePeriodSeconds,omitempty" json,yaml:"gracePeriodSeconds,omitempty"`
	...
	OrphanDependents bool `json:"orphanDependents,omitempty" json,yaml:"orphanDependents,omitempty"`

	// Must be fulfilled before a deletion is carried out. If not possible, a 409 Conflict status will be returned.
	Preconditions *IoK8sApimachineryPkgApisMetaV1Preconditions `json:"preconditions,omitempty" json,yaml:"preconditions,omitempty"`

	// Whether and how garbage collection will be performed. Either this field or OrphanDependents may be set, but not both. The default policy is decided by the existing finalizer set in the metadata.finalizers and the resource-specific default policy. Acceptable values are: 'Orphan' - orphan the dependents; 'Background' - allow the garbage collector to delete the dependents in the background; 'Foreground' - a cascading policy that deletes all dependents in the foreground.
	PropagationPolicy string `json:"propagationPolicy,omitempty" json,yaml:"propagationPolicy,omitempty"`
}
...
// ContextValidate validate this io k8s apimachinery pkg apis meta v1 delete options based on the context it is used
func (m *IoK8sApimachineryPkgApisMetaV1DeleteOptions) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sApimachineryPkgApisMetaV1DeleteOptions) contextValidatePreconditions(ctx context.Context, formats strfmt.Registry) error {
