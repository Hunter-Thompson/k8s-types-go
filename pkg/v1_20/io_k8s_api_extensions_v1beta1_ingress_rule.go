...
type IoK8sAPIExtensionsV1beta1IngressRule struct {
	...
	// http
	HTTP *IoK8sAPIExtensionsV1beta1HTTPIngressRuleValue `json:"http,omitempty" json,yaml:"http,omitempty"`
}
...
// ContextValidate validate this io k8s api extensions v1beta1 ingress rule based on the context it is used
func (m *IoK8sAPIExtensionsV1beta1IngressRule) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIExtensionsV1beta1IngressRule) contextValidateHTTP(ctx context.Context, formats strfmt.Registry) error {
