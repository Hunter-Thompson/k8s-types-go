...
// ContextValidate validate this io k8s api coordination v1beta1 lease spec based on the context it is used
func (m *IoK8sAPICoordinationV1beta1LeaseSpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoordinationV1beta1LeaseSpec) contextValidateAcquireTime(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPICoordinationV1beta1LeaseSpec) contextValidateRenewTime(ctx context.Context, formats strfmt.Registry) error {
