...
// ContextValidate validates this io k8s api networking v1beta1 ingress TLS based on context it is used
func (m *IoK8sAPINetworkingV1beta1IngressTLS) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
