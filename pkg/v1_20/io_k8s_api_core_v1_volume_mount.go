...
// ContextValidate validates this io k8s api core v1 volume mount based on context it is used
func (m *IoK8sAPICoreV1VolumeMount) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
