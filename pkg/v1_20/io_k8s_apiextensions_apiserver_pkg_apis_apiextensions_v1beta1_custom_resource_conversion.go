...
type IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceConversion struct {
	...
	// Required: true
	Strategy *string `json:"strategy" json,yaml:"strategy"`

	// webhookClientConfig is the instructions for how to call the webhook if strategy is `Webhook`. Required when `strategy` is set to `Webhook`.
	WebhookClientConfig *IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1WebhookClientConfig `json:"webhookClientConfig,omitempty" json,yaml:"webhookClientConfig,omitempty"`
}
	...
	if m.WebhookClientConfig != nil {
		if err := m.WebhookClientConfig.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("webhookClientConfig")
			}
			return err
		}
	}
...
// ContextValidate validate this io k8s apiextensions apiserver pkg apis apiextensions v1beta1 custom resource conversion based on the context it is used
func (m *IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceConversion) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error

	if err := m.contextValidateWebhookClientConfig(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceConversion) contextValidateWebhookClientConfig(ctx context.Context, formats strfmt.Registry) error {

	if m.WebhookClientConfig != nil {
		if err := m.WebhookClientConfig.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("webhookClientConfig")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("webhookClientConfig")
