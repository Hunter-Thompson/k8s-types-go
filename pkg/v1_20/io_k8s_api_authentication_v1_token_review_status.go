...
type IoK8sAPIAuthenticationV1TokenReviewStatus struct {
	...
	User *IoK8sAPIAuthenticationV1UserInfo `json:"user,omitempty" json,yaml:"user,omitempty"`
}
...
// ContextValidate validate this io k8s api authentication v1 token review status based on the context it is used
func (m *IoK8sAPIAuthenticationV1TokenReviewStatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAuthenticationV1TokenReviewStatus) contextValidateUser(ctx context.Context, formats strfmt.Registry) error {
