...
// ContextValidate validate this io k8s api autoscaling v2beta2 external metric source based on the context it is used
func (m *IoK8sAPIAutoscalingV2beta2ExternalMetricSource) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAutoscalingV2beta2ExternalMetricSource) contextValidateMetric(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIAutoscalingV2beta2ExternalMetricSource) contextValidateTarget(ctx context.Context, formats strfmt.Registry) error {
