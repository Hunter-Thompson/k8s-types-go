...
type IoK8sApimachineryPkgApisMetaV1StatusDetails struct {
	...
	Causes []*IoK8sApimachineryPkgApisMetaV1StatusCause `json:"causes" json,yaml:"causes"`
	...
	RetryAfterSeconds int32 `json:"retryAfterSeconds,omitempty" json,yaml:"retryAfterSeconds,omitempty"`
...
// ContextValidate validate this io k8s apimachinery pkg apis meta v1 status details based on the context it is used
func (m *IoK8sApimachineryPkgApisMetaV1StatusDetails) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sApimachineryPkgApisMetaV1StatusDetails) contextValidateCauses(ctx context.Context, formats strfmt.Registry) error {
