...
type IoK8sAPIAdmissionregistrationV1beta1ValidatingWebhookConfiguration struct {
	...
	Webhooks []*IoK8sAPIAdmissionregistrationV1beta1ValidatingWebhook `json:"webhooks" json,yaml:"webhooks"`
}
...
// ContextValidate validate this io k8s api admissionregistration v1beta1 validating webhook configuration based on the context it is used
func (m *IoK8sAPIAdmissionregistrationV1beta1ValidatingWebhookConfiguration) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAdmissionregistrationV1beta1ValidatingWebhookConfiguration) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIAdmissionregistrationV1beta1ValidatingWebhookConfiguration) contextValidateWebhooks(ctx context.Context, formats strfmt.Registry) error {
