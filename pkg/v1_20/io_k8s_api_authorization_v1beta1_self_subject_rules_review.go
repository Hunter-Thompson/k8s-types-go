...
type IoK8sAPIAuthorizationV1beta1SelfSubjectRulesReview struct {
	...
	// Required: true
	Spec *IoK8sAPIAuthorizationV1beta1SelfSubjectRulesReviewSpec `json:"spec" json,yaml:"spec"`

	// Status is filled in by the server and indicates the set of actions a user can perform.
	Status *IoK8sAPIAuthorizationV1beta1SubjectRulesReviewStatus `json:"status,omitempty" json,yaml:"status,omitempty"`
}
...
// ContextValidate validate this io k8s api authorization v1beta1 self subject rules review based on the context it is used
func (m *IoK8sAPIAuthorizationV1beta1SelfSubjectRulesReview) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAuthorizationV1beta1SelfSubjectRulesReview) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIAuthorizationV1beta1SelfSubjectRulesReview) contextValidateSpec(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIAuthorizationV1beta1SelfSubjectRulesReview) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
