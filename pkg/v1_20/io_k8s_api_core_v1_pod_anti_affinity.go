...
type IoK8sAPICoreV1PodAntiAffinity struct {
	...
	PreferredDuringSchedulingIgnoredDuringExecution []*IoK8sAPICoreV1WeightedPodAffinityTerm `json:"preferredDuringSchedulingIgnoredDuringExecution" json,yaml:"preferredDuringSchedulingIgnoredDuringExecution"`

	// If the anti-affinity requirements specified by this field are not met at scheduling time, the pod will not be scheduled onto the node. If the anti-affinity requirements specified by this field cease to be met at some point during pod execution (e.g. due to a pod label update), the system may or may not try to eventually evict the pod from its node. When there are multiple elements, the lists of nodes corresponding to each podAffinityTerm are intersected, i.e. all terms must be satisfied.
	RequiredDuringSchedulingIgnoredDuringExecution []*IoK8sAPICoreV1PodAffinityTerm `json:"requiredDuringSchedulingIgnoredDuringExecution" json,yaml:"requiredDuringSchedulingIgnoredDuringExecution"`
}
...
// ContextValidate validate this io k8s api core v1 pod anti affinity based on the context it is used
func (m *IoK8sAPICoreV1PodAntiAffinity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1PodAntiAffinity) contextValidatePreferredDuringSchedulingIgnoredDuringExecution(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1PodAntiAffinity) contextValidateRequiredDuringSchedulingIgnoredDuringExecution(ctx context.Context, formats strfmt.Registry) error {
