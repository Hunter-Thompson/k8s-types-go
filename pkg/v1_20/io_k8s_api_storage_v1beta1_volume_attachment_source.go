...
// ContextValidate validate this io k8s api storage v1beta1 volume attachment source based on the context it is used
func (m *IoK8sAPIStorageV1beta1VolumeAttachmentSource) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIStorageV1beta1VolumeAttachmentSource) contextValidateInlineVolumeSpec(ctx context.Context, formats strfmt.Registry) error {
