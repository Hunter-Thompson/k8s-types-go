...
// ContextValidate validates this io k8s api core v1 attached volume based on context it is used
func (m *IoK8sAPICoreV1AttachedVolume) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
