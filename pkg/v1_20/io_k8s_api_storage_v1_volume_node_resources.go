...
// ContextValidate validates this io k8s api storage v1 volume node resources based on context it is used
func (m *IoK8sAPIStorageV1VolumeNodeResources) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
