...
type IoK8sAPIFlowcontrolV1alpha1FlowSchemaStatus struct {
	...
	Conditions []*IoK8sAPIFlowcontrolV1alpha1FlowSchemaCondition `json:"conditions" json,yaml:"conditions"`
}
...
// ContextValidate validate this io k8s api flowcontrol v1alpha1 flow schema status based on the context it is used
func (m *IoK8sAPIFlowcontrolV1alpha1FlowSchemaStatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIFlowcontrolV1alpha1FlowSchemaStatus) contextValidateConditions(ctx context.Context, formats strfmt.Registry) error {
