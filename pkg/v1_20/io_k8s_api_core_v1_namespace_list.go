...
type IoK8sAPICoreV1NamespaceList struct {
	...
	// Required: true
	Items []*IoK8sAPICoreV1Namespace `json:"items" json,yaml:"items"`
...
// ContextValidate validate this io k8s api core v1 namespace list based on the context it is used
func (m *IoK8sAPICoreV1NamespaceList) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1NamespaceList) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1NamespaceList) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
