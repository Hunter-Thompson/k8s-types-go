...
type IoK8sAPICoreV1NodeConfigStatus struct {
	...
	Active *IoK8sAPICoreV1NodeConfigSource `json:"active,omitempty" json,yaml:"active,omitempty"`

	// Assigned reports the checkpointed config the node will try to use. When Node.Spec.ConfigSource is updated, the node checkpoints the associated config payload to local disk, along with a record indicating intended config. The node refers to this record to choose its config checkpoint, and reports this record in Assigned. Assigned only updates in the status after the record has been checkpointed to disk. When the Kubelet is restarted, it tries to make the Assigned config the Active config by loading and validating the checkpointed payload identified by Assigned.
	Assigned *IoK8sAPICoreV1NodeConfigSource `json:"assigned,omitempty" json,yaml:"assigned,omitempty"`
	...
	LastKnownGood *IoK8sAPICoreV1NodeConfigSource `json:"lastKnownGood,omitempty" json,yaml:"lastKnownGood,omitempty"`
}
...
// ContextValidate validate this io k8s api core v1 node config status based on the context it is used
func (m *IoK8sAPICoreV1NodeConfigStatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1NodeConfigStatus) contextValidateActive(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1NodeConfigStatus) contextValidateAssigned(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1NodeConfigStatus) contextValidateLastKnownGood(ctx context.Context, formats strfmt.Registry) error {
