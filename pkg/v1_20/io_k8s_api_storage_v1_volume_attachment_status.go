...
// ContextValidate validate this io k8s api storage v1 volume attachment status based on the context it is used
func (m *IoK8sAPIStorageV1VolumeAttachmentStatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIStorageV1VolumeAttachmentStatus) contextValidateAttachError(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIStorageV1VolumeAttachmentStatus) contextValidateDetachError(ctx context.Context, formats strfmt.Registry) error {
