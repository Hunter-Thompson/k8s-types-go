...
// ContextValidate validates this io k8s api rbac v1 subject based on context it is used
func (m *IoK8sAPIRbacV1Subject) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
