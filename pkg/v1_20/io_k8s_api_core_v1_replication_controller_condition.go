...
// ContextValidate validate this io k8s api core v1 replication controller condition based on the context it is used
func (m *IoK8sAPICoreV1ReplicationControllerCondition) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1ReplicationControllerCondition) contextValidateLastTransitionTime(ctx context.Context, formats strfmt.Registry) error {
