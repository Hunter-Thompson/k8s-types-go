...
// ContextValidate validate this io k8s api extensions v1beta1 ingress status based on the context it is used
func (m *IoK8sAPIExtensionsV1beta1IngressStatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIExtensionsV1beta1IngressStatus) contextValidateLoadBalancer(ctx context.Context, formats strfmt.Registry) error {
