...
type IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceDefinitionSpec struct {
	...
	Conversion *IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceConversion `json:"conversion,omitempty" json,yaml:"conversion,omitempty"`
	...
	// Required: true
	Names *IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceDefinitionNames `json:"names" json,yaml:"names"`
	...
	Validation *IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceValidation `json:"validation,omitempty" json,yaml:"validation,omitempty"`
	...
	Versions []*IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceDefinitionVersion `json:"versions" json,yaml:"versions"`
}
...
// ContextValidate validate this io k8s apiextensions apiserver pkg apis apiextensions v1beta1 custom resource definition spec based on the context it is used
func (m *IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceDefinitionSpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceDefinitionSpec) contextValidateAdditionalPrinterColumns(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceDefinitionSpec) contextValidateConversion(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceDefinitionSpec) contextValidateNames(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceDefinitionSpec) contextValidateSubresources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceDefinitionSpec) contextValidateValidation(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceDefinitionSpec) contextValidateVersions(ctx context.Context, formats strfmt.Registry) error {
