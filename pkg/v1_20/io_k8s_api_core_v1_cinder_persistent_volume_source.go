...
// ContextValidate validate this io k8s api core v1 cinder persistent volume source based on the context it is used
func (m *IoK8sAPICoreV1CinderPersistentVolumeSource) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1CinderPersistentVolumeSource) contextValidateSecretRef(ctx context.Context, formats strfmt.Registry) error {
