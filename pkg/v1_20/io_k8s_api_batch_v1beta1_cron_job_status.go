...
func (m *IoK8sAPIBatchV1beta1CronJobStatus) contextValidateActive(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIBatchV1beta1CronJobStatus) contextValidateLastScheduleTime(ctx context.Context, formats strfmt.Registry) error {
