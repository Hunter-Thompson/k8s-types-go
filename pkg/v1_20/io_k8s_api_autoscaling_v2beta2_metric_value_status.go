...
// ContextValidate validate this io k8s api autoscaling v2beta2 metric value status based on the context it is used
func (m *IoK8sAPIAutoscalingV2beta2MetricValueStatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAutoscalingV2beta2MetricValueStatus) contextValidateAverageValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIAutoscalingV2beta2MetricValueStatus) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
