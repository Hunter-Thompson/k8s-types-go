...
type IoK8sAPICoreV1DownwardAPIVolumeFile struct {
	...
	Mode int32 `json:"mode,omitempty" json,yaml:"mode,omitempty"`
...
// ContextValidate validate this io k8s api core v1 downward API volume file based on the context it is used
func (m *IoK8sAPICoreV1DownwardAPIVolumeFile) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1DownwardAPIVolumeFile) contextValidateFieldRef(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1DownwardAPIVolumeFile) contextValidateResourceFieldRef(ctx context.Context, formats strfmt.Registry) error {
