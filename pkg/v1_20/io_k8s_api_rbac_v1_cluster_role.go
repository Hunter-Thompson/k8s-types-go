...
type IoK8sAPIRbacV1ClusterRole struct {
	...
	AggregationRule *IoK8sAPIRbacV1AggregationRule `json:"aggregationRule,omitempty" json,yaml:"aggregationRule,omitempty"`
...
// ContextValidate validate this io k8s api rbac v1 cluster role based on the context it is used
func (m *IoK8sAPIRbacV1ClusterRole) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIRbacV1ClusterRole) contextValidateAggregationRule(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1ClusterRole) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1ClusterRole) contextValidateRules(ctx context.Context, formats strfmt.Registry) error {
