...
// ContextValidate validates this io k8s api rbac v1beta1 subject based on context it is used
func (m *IoK8sAPIRbacV1beta1Subject) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
