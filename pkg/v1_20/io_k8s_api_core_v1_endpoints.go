...
type IoK8sAPICoreV1Endpoints struct {
	...
	Subsets []*IoK8sAPICoreV1EndpointSubset `json:"subsets" json,yaml:"subsets"`
}
		...
		if m.Subsets[i] != nil {
			if err := m.Subsets[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("subsets" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
// ContextValidate validate this io k8s api core v1 endpoints based on the context it is used
func (m *IoK8sAPICoreV1Endpoints) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
	...
	if err := m.contextValidateSubsets(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *IoK8sAPICoreV1Endpoints) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1Endpoints) contextValidateSubsets(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.Subsets); i++ {

		if m.Subsets[i] != nil {
			if err := m.Subsets[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("subsets" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("subsets" + "." + strconv.Itoa(i))
