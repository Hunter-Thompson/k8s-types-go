...
type IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIService struct {
	...
	Spec *IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIServiceSpec `json:"spec,omitempty" json,yaml:"spec,omitempty"`

	// Status contains derived information about an API server
	Status *IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIServiceStatus `json:"status,omitempty" json,yaml:"status,omitempty"`
}
...
// ContextValidate validate this io k8s kube aggregator pkg apis apiregistration v1beta1 API service based on the context it is used
func (m *IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIService) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIService) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIService) contextValidateSpec(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIService) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
