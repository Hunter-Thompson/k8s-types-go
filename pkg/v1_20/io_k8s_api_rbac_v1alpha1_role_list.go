...
type IoK8sAPIRbacV1alpha1RoleList struct {
	...
	// Required: true
	Items []*IoK8sAPIRbacV1alpha1Role `json:"items" json,yaml:"items"`
...
// ContextValidate validate this io k8s api rbac v1alpha1 role list based on the context it is used
func (m *IoK8sAPIRbacV1alpha1RoleList) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIRbacV1alpha1RoleList) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1alpha1RoleList) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
