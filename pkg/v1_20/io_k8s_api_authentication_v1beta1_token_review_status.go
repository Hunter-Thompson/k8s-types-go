...
type IoK8sAPIAuthenticationV1beta1TokenReviewStatus struct {
	...
	Authenticated bool `json:"authenticated,omitempty" json,yaml:"authenticated,omitempty"`

	// Error indicates that the token couldn't be checked
	Error string `json:"error,omitempty" json,yaml:"error,omitempty"`

	// User is the UserInfo associated with the provided token.
	User *IoK8sAPIAuthenticationV1beta1UserInfo `json:"user,omitempty" json,yaml:"user,omitempty"`
}
...
// ContextValidate validate this io k8s api authentication v1beta1 token review status based on the context it is used
func (m *IoK8sAPIAuthenticationV1beta1TokenReviewStatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAuthenticationV1beta1TokenReviewStatus) contextValidateUser(ctx context.Context, formats strfmt.Registry) error {
