...
type IoK8sAPIExtensionsV1beta1HTTPIngressPath struct {
	...
	// Required: true
	Backend *IoK8sAPIExtensionsV1beta1IngressBackend `json:"backend" json,yaml:"backend"`
...
// ContextValidate validate this io k8s api extensions v1beta1 HTTP ingress path based on the context it is used
func (m *IoK8sAPIExtensionsV1beta1HTTPIngressPath) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIExtensionsV1beta1HTTPIngressPath) contextValidateBackend(ctx context.Context, formats strfmt.Registry) error {
