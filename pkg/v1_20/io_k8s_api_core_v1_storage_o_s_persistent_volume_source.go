...
type IoK8sAPICoreV1StorageOSPersistentVolumeSource struct {
	...
	SecretRef *IoK8sAPICoreV1ObjectReference `json:"secretRef,omitempty" json,yaml:"secretRef,omitempty"`
	...
	VolumeNamespace string `json:"volumeNamespace,omitempty" json,yaml:"volumeNamespace,omitempty"`
}
...
// ContextValidate validate this io k8s api core v1 storage o s persistent volume source based on the context it is used
func (m *IoK8sAPICoreV1StorageOSPersistentVolumeSource) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1StorageOSPersistentVolumeSource) contextValidateSecretRef(ctx context.Context, formats strfmt.Registry) error {
