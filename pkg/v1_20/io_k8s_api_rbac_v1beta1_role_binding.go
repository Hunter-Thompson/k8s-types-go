...
// ContextValidate validate this io k8s api rbac v1beta1 role binding based on the context it is used
func (m *IoK8sAPIRbacV1beta1RoleBinding) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIRbacV1beta1RoleBinding) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1beta1RoleBinding) contextValidateRoleRef(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1beta1RoleBinding) contextValidateSubjects(ctx context.Context, formats strfmt.Registry) error {
