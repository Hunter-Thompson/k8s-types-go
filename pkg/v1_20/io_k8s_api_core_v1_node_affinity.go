...
type IoK8sAPICoreV1NodeAffinity struct {
	...
	PreferredDuringSchedulingIgnoredDuringExecution []*IoK8sAPICoreV1PreferredSchedulingTerm `json:"preferredDuringSchedulingIgnoredDuringExecution" json,yaml:"preferredDuringSchedulingIgnoredDuringExecution"`

	// If the affinity requirements specified by this field are not met at scheduling time, the pod will not be scheduled onto the node. If the affinity requirements specified by this field cease to be met at some point during pod execution (e.g. due to an update), the system may or may not try to eventually evict the pod from its node.
	RequiredDuringSchedulingIgnoredDuringExecution *IoK8sAPICoreV1NodeSelector `json:"requiredDuringSchedulingIgnoredDuringExecution,omitempty" json,yaml:"requiredDuringSchedulingIgnoredDuringExecution,omitempty"`
}
...
// ContextValidate validate this io k8s api core v1 node affinity based on the context it is used
func (m *IoK8sAPICoreV1NodeAffinity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1NodeAffinity) contextValidatePreferredDuringSchedulingIgnoredDuringExecution(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1NodeAffinity) contextValidateRequiredDuringSchedulingIgnoredDuringExecution(ctx context.Context, formats strfmt.Registry) error {
