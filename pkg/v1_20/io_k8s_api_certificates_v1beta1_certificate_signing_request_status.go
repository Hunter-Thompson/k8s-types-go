...
type IoK8sAPICertificatesV1beta1CertificateSigningRequestStatus struct {
	...
	Conditions []*IoK8sAPICertificatesV1beta1CertificateSigningRequestCondition `json:"conditions" json,yaml:"conditions"`
}
...
// ContextValidate validate this io k8s api certificates v1beta1 certificate signing request status based on the context it is used
func (m *IoK8sAPICertificatesV1beta1CertificateSigningRequestStatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICertificatesV1beta1CertificateSigningRequestStatus) contextValidateConditions(ctx context.Context, formats strfmt.Registry) error {
