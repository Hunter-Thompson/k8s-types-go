...
// ContextValidate validate this io k8s api core v1 secret projection based on the context it is used
func (m *IoK8sAPICoreV1SecretProjection) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1SecretProjection) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
