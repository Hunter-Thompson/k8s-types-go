...
type IoK8sAPIRbacV1beta1RoleList struct {
	...
	// Required: true
	Items []*IoK8sAPIRbacV1beta1Role `json:"items" json,yaml:"items"`
...
// ContextValidate validate this io k8s api rbac v1beta1 role list based on the context it is used
func (m *IoK8sAPIRbacV1beta1RoleList) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIRbacV1beta1RoleList) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1beta1RoleList) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
