...
type IoK8sAPINetworkingV1NetworkPolicyIngressRule struct {
	...
	From []*IoK8sAPINetworkingV1NetworkPolicyPeer `json:"from" json,yaml:"from"`

	// List of ports which should be made accessible on the pods selected for this rule. Each item in this list is combined using a logical OR. If this field is empty or missing, this rule matches all ports (traffic not restricted by port). If this field is present and contains at least one item, then this rule allows traffic only if the traffic matches at least one port in the list.
	Ports []*IoK8sAPINetworkingV1NetworkPolicyPort `json:"ports" json,yaml:"ports"`
}
...
// ContextValidate validate this io k8s api networking v1 network policy ingress rule based on the context it is used
func (m *IoK8sAPINetworkingV1NetworkPolicyIngressRule) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPINetworkingV1NetworkPolicyIngressRule) contextValidateFrom(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPINetworkingV1NetworkPolicyIngressRule) contextValidatePorts(ctx context.Context, formats strfmt.Registry) error {
