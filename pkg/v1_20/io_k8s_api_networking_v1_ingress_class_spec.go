...
// ContextValidate validate this io k8s api networking v1 ingress class spec based on the context it is used
func (m *IoK8sAPINetworkingV1IngressClassSpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPINetworkingV1IngressClassSpec) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
