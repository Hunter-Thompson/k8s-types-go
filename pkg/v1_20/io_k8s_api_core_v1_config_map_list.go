...
type IoK8sAPICoreV1ConfigMapList struct {
	...
	// Required: true
	Items []*IoK8sAPICoreV1ConfigMap `json:"items" json,yaml:"items"`
...
// ContextValidate validate this io k8s api core v1 config map list based on the context it is used
func (m *IoK8sAPICoreV1ConfigMapList) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1ConfigMapList) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1ConfigMapList) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
