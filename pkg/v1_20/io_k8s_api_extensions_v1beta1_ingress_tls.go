...
type IoK8sAPIExtensionsV1beta1IngressTLS struct {
	...
	Hosts []string `json:"hosts" json,yaml:"hosts"`
...
// ContextValidate validates this io k8s api extensions v1beta1 ingress TLS based on context it is used
func (m *IoK8sAPIExtensionsV1beta1IngressTLS) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
