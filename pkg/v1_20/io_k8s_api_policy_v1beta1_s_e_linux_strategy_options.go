...
// ContextValidate validate this io k8s api policy v1beta1 s e linux strategy options based on the context it is used
func (m *IoK8sAPIPolicyV1beta1SELinuxStrategyOptions) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIPolicyV1beta1SELinuxStrategyOptions) contextValidateSeLinuxOptions(ctx context.Context, formats strfmt.Registry) error {
