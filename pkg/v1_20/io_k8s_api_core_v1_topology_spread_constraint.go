...
var ioK8sApiCoreV1TopologySpreadConstraintTypeWhenUnsatisfiablePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		ioK8sApiCoreV1TopologySpreadConstraintTypeWhenUnsatisfiablePropEnum = append(ioK8sApiCoreV1TopologySpreadConstraintTypeWhenUnsatisfiablePropEnum, v)
	}
}

const (

	// IoK8sAPICoreV1TopologySpreadConstraintWhenUnsatisfiableDoNotSchedule captures enum value "DoNotSchedule"
	IoK8sAPICoreV1TopologySpreadConstraintWhenUnsatisfiableDoNotSchedule string = "DoNotSchedule"

	// IoK8sAPICoreV1TopologySpreadConstraintWhenUnsatisfiableScheduleAnyway captures enum value "ScheduleAnyway"
	IoK8sAPICoreV1TopologySpreadConstraintWhenUnsatisfiableScheduleAnyway string = "ScheduleAnyway"
)

// prop value enum
func (m *IoK8sAPICoreV1TopologySpreadConstraint) validateWhenUnsatisfiableEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, ioK8sApiCoreV1TopologySpreadConstraintTypeWhenUnsatisfiablePropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *IoK8sAPICoreV1TopologySpreadConstraint) validateWhenUnsatisfiable(formats strfmt.Registry) error {
	...
	// value enum
	if err := m.validateWhenUnsatisfiableEnum("whenUnsatisfiable", "body", *m.WhenUnsatisfiable); err != nil {
		return err
	}
...
// ContextValidate validate this io k8s api core v1 topology spread constraint based on the context it is used
func (m *IoK8sAPICoreV1TopologySpreadConstraint) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1TopologySpreadConstraint) contextValidateLabelSelector(ctx context.Context, formats strfmt.Registry) error {
