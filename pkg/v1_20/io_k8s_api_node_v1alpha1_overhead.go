...
// ContextValidate validate this io k8s api node v1alpha1 overhead based on the context it is used
func (m *IoK8sAPINodeV1alpha1Overhead) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPINodeV1alpha1Overhead) contextValidatePodFixed(ctx context.Context, formats strfmt.Registry) error {
