...
type IoK8sAPIStorageV1CSINode struct {
	...
	// Required: true
	Spec *IoK8sAPIStorageV1CSINodeSpec `json:"spec" json,yaml:"spec"`
}
...
// ContextValidate validate this io k8s api storage v1 c s i node based on the context it is used
func (m *IoK8sAPIStorageV1CSINode) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIStorageV1CSINode) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIStorageV1CSINode) contextValidateSpec(ctx context.Context, formats strfmt.Registry) error {
