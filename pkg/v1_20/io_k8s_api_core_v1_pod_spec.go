...
var ioK8sApiCoreV1PodSpecTypeDNSPolicyPropEnum []interface{}

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["ClusterFirst","ClusterFirstWithHostNet","Default","None"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		ioK8sApiCoreV1PodSpecTypeDNSPolicyPropEnum = append(ioK8sApiCoreV1PodSpecTypeDNSPolicyPropEnum, v)
	}
}

const (

	// IoK8sAPICoreV1PodSpecDNSPolicyClusterFirst captures enum value "ClusterFirst"
	IoK8sAPICoreV1PodSpecDNSPolicyClusterFirst string = "ClusterFirst"

	// IoK8sAPICoreV1PodSpecDNSPolicyClusterFirstWithHostNet captures enum value "ClusterFirstWithHostNet"
	IoK8sAPICoreV1PodSpecDNSPolicyClusterFirstWithHostNet string = "ClusterFirstWithHostNet"

	// IoK8sAPICoreV1PodSpecDNSPolicyDefault captures enum value "Default"
	IoK8sAPICoreV1PodSpecDNSPolicyDefault string = "Default"

	// IoK8sAPICoreV1PodSpecDNSPolicyNone captures enum value "None"
	IoK8sAPICoreV1PodSpecDNSPolicyNone string = "None"
)

// prop value enum
func (m *IoK8sAPICoreV1PodSpec) validateDNSPolicyEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, ioK8sApiCoreV1PodSpecTypeDNSPolicyPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *IoK8sAPICoreV1PodSpec) validateDNSPolicy(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1PodSpec) validateOs(formats strfmt.Registry) error {
...
var ioK8sApiCoreV1PodSpecTypeRestartPolicyPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		ioK8sApiCoreV1PodSpecTypeRestartPolicyPropEnum = append(ioK8sApiCoreV1PodSpecTypeRestartPolicyPropEnum, v)
	}
}

const (

	// IoK8sAPICoreV1PodSpecRestartPolicyAlways captures enum value "Always"
	IoK8sAPICoreV1PodSpecRestartPolicyAlways string = "Always"

	// IoK8sAPICoreV1PodSpecRestartPolicyNever captures enum value "Never"
	IoK8sAPICoreV1PodSpecRestartPolicyNever string = "Never"

	// IoK8sAPICoreV1PodSpecRestartPolicyOnFailure captures enum value "OnFailure"
	IoK8sAPICoreV1PodSpecRestartPolicyOnFailure string = "OnFailure"
)

// prop value enum
func (m *IoK8sAPICoreV1PodSpec) validateRestartPolicyEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, ioK8sApiCoreV1PodSpecTypeRestartPolicyPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *IoK8sAPICoreV1PodSpec) validateRestartPolicy(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1PodSpec) contextValidateOs(ctx context.Context, formats strfmt.Registry) error {
