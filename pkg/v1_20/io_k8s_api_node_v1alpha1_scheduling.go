...
// ContextValidate validate this io k8s api node v1alpha1 scheduling based on the context it is used
func (m *IoK8sAPINodeV1alpha1Scheduling) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPINodeV1alpha1Scheduling) contextValidateTolerations(ctx context.Context, formats strfmt.Registry) error {
