...
// ContextValidate validates this io k8s api certificates v1 certificate signing request spec based on context it is used
func (m *IoK8sAPICertificatesV1CertificateSigningRequestSpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
