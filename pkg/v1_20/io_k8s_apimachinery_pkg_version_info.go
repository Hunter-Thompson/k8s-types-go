...
// ContextValidate validates this io k8s apimachinery pkg version info based on context it is used
func (m *IoK8sApimachineryPkgVersionInfo) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
