...
type IoK8sAPIAdmissionregistrationV1beta1ValidatingWebhookConfigurationList struct {
	...
	// Required: true
	Items []*IoK8sAPIAdmissionregistrationV1beta1ValidatingWebhookConfiguration `json:"items" json,yaml:"items"`
...
// ContextValidate validate this io k8s api admissionregistration v1beta1 validating webhook configuration list based on the context it is used
func (m *IoK8sAPIAdmissionregistrationV1beta1ValidatingWebhookConfigurationList) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAdmissionregistrationV1beta1ValidatingWebhookConfigurationList) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIAdmissionregistrationV1beta1ValidatingWebhookConfigurationList) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
