...
// ContextValidate validate this io k8s api autoscaling v1 horizontal pod autoscaler spec based on the context it is used
func (m *IoK8sAPIAutoscalingV1HorizontalPodAutoscalerSpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAutoscalingV1HorizontalPodAutoscalerSpec) contextValidateScaleTargetRef(ctx context.Context, formats strfmt.Registry) error {
