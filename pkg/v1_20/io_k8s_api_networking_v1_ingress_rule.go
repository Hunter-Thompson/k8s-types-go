...
type IoK8sAPINetworkingV1IngressRule struct {
	...
	// http
	HTTP *IoK8sAPINetworkingV1HTTPIngressRuleValue `json:"http,omitempty" json,yaml:"http,omitempty"`
}
...
// ContextValidate validate this io k8s api networking v1 ingress rule based on the context it is used
func (m *IoK8sAPINetworkingV1IngressRule) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPINetworkingV1IngressRule) contextValidateHTTP(ctx context.Context, formats strfmt.Registry) error {
