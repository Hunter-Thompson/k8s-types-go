...
// ContextValidate validates this io k8s api core v1 a w s elastic block store volume source based on context it is used
func (m *IoK8sAPICoreV1AWSElasticBlockStoreVolumeSource) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
