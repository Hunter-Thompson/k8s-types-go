...
type IoK8sAPIStorageV1CSINodeDriver struct {
	...
	Allocatable *IoK8sAPIStorageV1VolumeNodeResources `json:"allocatable,omitempty" json,yaml:"allocatable,omitempty"`
...
// ContextValidate validate this io k8s api storage v1 c s i node driver based on the context it is used
func (m *IoK8sAPIStorageV1CSINodeDriver) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIStorageV1CSINodeDriver) contextValidateAllocatable(ctx context.Context, formats strfmt.Registry) error {
