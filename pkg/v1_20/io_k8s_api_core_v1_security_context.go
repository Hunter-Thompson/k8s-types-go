...
type IoK8sAPICoreV1SecurityContext struct {
	...
	Capabilities *IoK8sAPICoreV1Capabilities `json:"capabilities,omitempty" json,yaml:"capabilities,omitempty"`
	...
	ProcMount string `json:"procMount,omitempty" json,yaml:"procMount,omitempty"`
	...
	RunAsGroup int64 `json:"runAsGroup,omitempty" json,yaml:"runAsGroup,omitempty"`

	// Indicates that the container must run as a non-root user. If true, the Kubelet will validate the image at runtime to ensure that it does not run as UID 0 (root) and fail to start the container if it does. If unset or false, no such validation will be performed. May also be set in PodSecurityContext.  If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence.
	RunAsNonRoot bool `json:"runAsNonRoot,omitempty" json,yaml:"runAsNonRoot,omitempty"`

	// The UID to run the entrypoint of the container process. Defaults to user specified in image metadata if unspecified. May also be set in PodSecurityContext.  If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence.
	RunAsUser int64 `json:"runAsUser,omitempty" json,yaml:"runAsUser,omitempty"`
	...
	SeccompProfile *IoK8sAPICoreV1SeccompProfile `json:"seccompProfile,omitempty" json,yaml:"seccompProfile,omitempty"`

	// The Windows specific settings applied to all containers. If unspecified, the options from the PodSecurityContext will be used. If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence.
	WindowsOptions *IoK8sAPICoreV1WindowsSecurityContextOptions `json:"windowsOptions,omitempty" json,yaml:"windowsOptions,omitempty"`
}
...
// ContextValidate validate this io k8s api core v1 security context based on the context it is used
func (m *IoK8sAPICoreV1SecurityContext) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1SecurityContext) contextValidateCapabilities(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1SecurityContext) contextValidateSeLinuxOptions(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1SecurityContext) contextValidateSeccompProfile(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1SecurityContext) contextValidateWindowsOptions(ctx context.Context, formats strfmt.Registry) error {
