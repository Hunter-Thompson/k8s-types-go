...
type IoK8sAPICoreV1EndpointAddress struct {
	...
	// Required: true
	IP *string `json:"ip" json,yaml:"ip"`

	// Optional: Node hosting this endpoint. This can be used to determine endpoints local to a node.
	NodeName string `json:"nodeName,omitempty" json,yaml:"nodeName,omitempty"`

	// Reference to object providing the endpoint.
	TargetRef *IoK8sAPICoreV1ObjectReference `json:"targetRef,omitempty" json,yaml:"targetRef,omitempty"`
}
...
// ContextValidate validate this io k8s api core v1 endpoint address based on the context it is used
func (m *IoK8sAPICoreV1EndpointAddress) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1EndpointAddress) contextValidateTargetRef(ctx context.Context, formats strfmt.Registry) error {
