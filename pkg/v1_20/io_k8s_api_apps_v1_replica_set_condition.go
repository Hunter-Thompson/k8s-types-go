...
// ContextValidate validate this io k8s api apps v1 replica set condition based on the context it is used
func (m *IoK8sAPIAppsV1ReplicaSetCondition) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAppsV1ReplicaSetCondition) contextValidateLastTransitionTime(ctx context.Context, formats strfmt.Registry) error {
