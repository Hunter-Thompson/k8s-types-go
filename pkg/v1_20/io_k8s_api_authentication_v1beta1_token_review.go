...
type IoK8sAPIAuthenticationV1beta1TokenReview struct {
	...
	// Required: true
	Spec *IoK8sAPIAuthenticationV1beta1TokenReviewSpec `json:"spec" json,yaml:"spec"`

	// Status is filled in by the server and indicates whether the request can be authenticated.
	Status *IoK8sAPIAuthenticationV1beta1TokenReviewStatus `json:"status,omitempty" json,yaml:"status,omitempty"`
}
...
// ContextValidate validate this io k8s api authentication v1beta1 token review based on the context it is used
func (m *IoK8sAPIAuthenticationV1beta1TokenReview) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAuthenticationV1beta1TokenReview) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIAuthenticationV1beta1TokenReview) contextValidateSpec(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIAuthenticationV1beta1TokenReview) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
