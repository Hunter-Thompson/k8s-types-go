...
// ContextValidate validates this io k8s api core v1 local object reference based on context it is used
func (m *IoK8sAPICoreV1LocalObjectReference) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
