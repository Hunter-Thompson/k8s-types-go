...
// ContextValidate validates this io k8s api authorization v1 resource rule based on context it is used
func (m *IoK8sAPIAuthorizationV1ResourceRule) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
