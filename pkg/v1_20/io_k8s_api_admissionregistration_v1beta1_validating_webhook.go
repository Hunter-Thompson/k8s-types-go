...
// ContextValidate validate this io k8s api admissionregistration v1beta1 validating webhook based on the context it is used
func (m *IoK8sAPIAdmissionregistrationV1beta1ValidatingWebhook) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAdmissionregistrationV1beta1ValidatingWebhook) contextValidateClientConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIAdmissionregistrationV1beta1ValidatingWebhook) contextValidateNamespaceSelector(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIAdmissionregistrationV1beta1ValidatingWebhook) contextValidateObjectSelector(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIAdmissionregistrationV1beta1ValidatingWebhook) contextValidateRules(ctx context.Context, formats strfmt.Registry) error {
