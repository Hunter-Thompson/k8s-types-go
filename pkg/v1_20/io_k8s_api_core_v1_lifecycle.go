...
type IoK8sAPICoreV1Lifecycle struct {
	...
	PostStart *IoK8sAPICoreV1Handler `json:"postStart,omitempty" json,yaml:"postStart,omitempty"`
	...
	PreStop *IoK8sAPICoreV1Handler `json:"preStop,omitempty" json,yaml:"preStop,omitempty"`
}
