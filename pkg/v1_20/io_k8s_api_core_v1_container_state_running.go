...
// ContextValidate validate this io k8s api core v1 container state running based on the context it is used
func (m *IoK8sAPICoreV1ContainerStateRunning) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1ContainerStateRunning) contextValidateStartedAt(ctx context.Context, formats strfmt.Registry) error {
