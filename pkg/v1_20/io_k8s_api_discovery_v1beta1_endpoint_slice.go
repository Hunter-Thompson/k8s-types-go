...
type IoK8sAPIDiscoveryV1beta1EndpointSlice struct {
	...
	// Required: true
	AddressType *string `json:"addressType" json,yaml:"addressType"`
	...
	// Required: true
	Endpoints []*IoK8sAPIDiscoveryV1beta1Endpoint `json:"endpoints" json,yaml:"endpoints"`
	...
	Ports []*IoK8sAPIDiscoveryV1beta1EndpointPort `json:"ports" json,yaml:"ports"`
}
...
// ContextValidate validate this io k8s api discovery v1beta1 endpoint slice based on the context it is used
func (m *IoK8sAPIDiscoveryV1beta1EndpointSlice) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIDiscoveryV1beta1EndpointSlice) contextValidateEndpoints(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIDiscoveryV1beta1EndpointSlice) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIDiscoveryV1beta1EndpointSlice) contextValidatePorts(ctx context.Context, formats strfmt.Registry) error {
