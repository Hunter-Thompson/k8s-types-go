...
// ContextValidate validate this io k8s apiextensions apiserver pkg apis apiextensions v1 webhook conversion based on the context it is used
func (m *IoK8sApiextensionsApiserverPkgApisApiextensionsV1WebhookConversion) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sApiextensionsApiserverPkgApisApiextensionsV1WebhookConversion) contextValidateClientConfig(ctx context.Context, formats strfmt.Registry) error {
