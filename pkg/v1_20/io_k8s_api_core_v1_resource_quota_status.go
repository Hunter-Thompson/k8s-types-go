...
// ContextValidate validate this io k8s api core v1 resource quota status based on the context it is used
func (m *IoK8sAPICoreV1ResourceQuotaStatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1ResourceQuotaStatus) contextValidateHard(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1ResourceQuotaStatus) contextValidateUsed(ctx context.Context, formats strfmt.Registry) error {
