...
// ContextValidate validate this io k8s api authorization v1 subject rules review status based on the context it is used
func (m *IoK8sAPIAuthorizationV1SubjectRulesReviewStatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAuthorizationV1SubjectRulesReviewStatus) contextValidateNonResourceRules(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIAuthorizationV1SubjectRulesReviewStatus) contextValidateResourceRules(ctx context.Context, formats strfmt.Registry) error {
