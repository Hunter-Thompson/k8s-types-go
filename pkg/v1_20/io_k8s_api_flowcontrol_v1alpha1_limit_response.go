...
type IoK8sAPIFlowcontrolV1alpha1LimitResponse struct {
	...
	Queuing *IoK8sAPIFlowcontrolV1alpha1QueuingConfiguration `json:"queuing,omitempty" json,yaml:"queuing,omitempty"`
...
// ContextValidate validate this io k8s api flowcontrol v1alpha1 limit response based on the context it is used
func (m *IoK8sAPIFlowcontrolV1alpha1LimitResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIFlowcontrolV1alpha1LimitResponse) contextValidateQueuing(ctx context.Context, formats strfmt.Registry) error {
