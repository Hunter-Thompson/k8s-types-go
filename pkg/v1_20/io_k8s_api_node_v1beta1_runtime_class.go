...
type IoK8sAPINodeV1beta1RuntimeClass struct {
	...
	Overhead *IoK8sAPINodeV1beta1Overhead `json:"overhead,omitempty" json,yaml:"overhead,omitempty"`

	// Scheduling holds the scheduling constraints to ensure that pods running with this RuntimeClass are scheduled to nodes that support it. If scheduling is nil, this RuntimeClass is assumed to be supported by all nodes.
	Scheduling *IoK8sAPINodeV1beta1Scheduling `json:"scheduling,omitempty" json,yaml:"scheduling,omitempty"`
}
...
// ContextValidate validate this io k8s api node v1beta1 runtime class based on the context it is used
func (m *IoK8sAPINodeV1beta1RuntimeClass) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPINodeV1beta1RuntimeClass) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPINodeV1beta1RuntimeClass) contextValidateOverhead(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPINodeV1beta1RuntimeClass) contextValidateScheduling(ctx context.Context, formats strfmt.Registry) error {
