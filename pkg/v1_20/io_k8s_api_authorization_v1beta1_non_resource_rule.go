...
// ContextValidate validates this io k8s api authorization v1beta1 non resource rule based on context it is used
func (m *IoK8sAPIAuthorizationV1beta1NonResourceRule) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
