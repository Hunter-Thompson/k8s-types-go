...
// ContextValidate validate this io k8s api core v1 resource requirements based on the context it is used
func (m *IoK8sAPICoreV1ResourceRequirements) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1ResourceRequirements) contextValidateLimits(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1ResourceRequirements) contextValidateRequests(ctx context.Context, formats strfmt.Registry) error {
