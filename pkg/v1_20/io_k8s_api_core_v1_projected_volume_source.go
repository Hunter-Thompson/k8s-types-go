...
type IoK8sAPICoreV1ProjectedVolumeSource struct {
	...
	Sources []*IoK8sAPICoreV1VolumeProjection `json:"sources" json,yaml:"sources"`
}
...
// ContextValidate validate this io k8s api core v1 projected volume source based on the context it is used
func (m *IoK8sAPICoreV1ProjectedVolumeSource) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1ProjectedVolumeSource) contextValidateSources(ctx context.Context, formats strfmt.Registry) error {
