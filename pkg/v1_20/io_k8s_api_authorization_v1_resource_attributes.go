...
// ContextValidate validates this io k8s api authorization v1 resource attributes based on context it is used
func (m *IoK8sAPIAuthorizationV1ResourceAttributes) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
