...
type IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceConversion struct {
	...
	Webhook *IoK8sApiextensionsApiserverPkgApisApiextensionsV1WebhookConversion `json:"webhook,omitempty" json,yaml:"webhook,omitempty"`
}
...
// ContextValidate validate this io k8s apiextensions apiserver pkg apis apiextensions v1 custom resource conversion based on the context it is used
func (m *IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceConversion) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceConversion) contextValidateWebhook(ctx context.Context, formats strfmt.Registry) error {
