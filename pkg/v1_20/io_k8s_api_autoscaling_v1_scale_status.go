...
// ContextValidate validates this io k8s api autoscaling v1 scale status based on context it is used
func (m *IoK8sAPIAutoscalingV1ScaleStatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
