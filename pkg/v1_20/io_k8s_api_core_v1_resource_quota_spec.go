...
// ContextValidate validate this io k8s api core v1 resource quota spec based on the context it is used
func (m *IoK8sAPICoreV1ResourceQuotaSpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1ResourceQuotaSpec) contextValidateHard(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1ResourceQuotaSpec) contextValidateScopeSelector(ctx context.Context, formats strfmt.Registry) error {
