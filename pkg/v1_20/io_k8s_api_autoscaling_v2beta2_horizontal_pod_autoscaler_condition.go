...
// ContextValidate validate this io k8s api autoscaling v2beta2 horizontal pod autoscaler condition based on the context it is used
func (m *IoK8sAPIAutoscalingV2beta2HorizontalPodAutoscalerCondition) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAutoscalingV2beta2HorizontalPodAutoscalerCondition) contextValidateLastTransitionTime(ctx context.Context, formats strfmt.Registry) error {
