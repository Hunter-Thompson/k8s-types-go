...
type IoK8sAPICoreV1EmptyDirVolumeSource struct {
	...
	Medium string `json:"medium,omitempty" json,yaml:"medium,omitempty"`

	// Total amount of local storage required for this EmptyDir volume. The size limit is also applicable for memory medium. The maximum usage on memory medium EmptyDir would be the minimum value between the SizeLimit specified here and the sum of memory limits of all containers in a pod. The default is nil which means that the limit is undefined. More info: http://kubernetes.io/docs/user-guide/volumes#emptydir
	SizeLimit IoK8sApimachineryPkgAPIResourceQuantity `json:"sizeLimit,omitempty" json,yaml:"sizeLimit,omitempty"`
}
...
// ContextValidate validate this io k8s api core v1 empty dir volume source based on the context it is used
func (m *IoK8sAPICoreV1EmptyDirVolumeSource) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1EmptyDirVolumeSource) contextValidateSizeLimit(ctx context.Context, formats strfmt.Registry) error {
