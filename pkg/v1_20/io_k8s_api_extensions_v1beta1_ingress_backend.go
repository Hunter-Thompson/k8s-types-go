...
// ContextValidate validate this io k8s api extensions v1beta1 ingress backend based on the context it is used
func (m *IoK8sAPIExtensionsV1beta1IngressBackend) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIExtensionsV1beta1IngressBackend) contextValidateResource(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPIExtensionsV1beta1IngressBackend) contextValidateServicePort(ctx context.Context, formats strfmt.Registry) error {
