...
// ContextValidate validates this io k8s apimachinery pkg apis meta v1 time based on context it is used
func (m IoK8sApimachineryPkgApisMetaV1Time) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
