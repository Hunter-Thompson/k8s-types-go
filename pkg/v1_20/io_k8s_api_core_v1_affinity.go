...
// ContextValidate validate this io k8s api core v1 affinity based on the context it is used
func (m *IoK8sAPICoreV1Affinity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1Affinity) contextValidateNodeAffinity(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1Affinity) contextValidatePodAffinity(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1Affinity) contextValidatePodAntiAffinity(ctx context.Context, formats strfmt.Registry) error {
