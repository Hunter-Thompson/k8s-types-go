...
type IoK8sAPICoreV1Probe struct {
	...
	FailureThreshold int32 `json:"failureThreshold,omitempty" json,yaml:"failureThreshold,omitempty"`
	...
	InitialDelaySeconds int32 `json:"initialDelaySeconds,omitempty" json,yaml:"initialDelaySeconds,omitempty"`

	// How often (in seconds) to perform the probe. Default to 10 seconds. Minimum value is 1.
	PeriodSeconds int32 `json:"periodSeconds,omitempty" json,yaml:"periodSeconds,omitempty"`

	// Minimum consecutive successes for the probe to be considered successful after having failed. Defaults to 1. Must be 1 for liveness and startup. Minimum value is 1.
	SuccessThreshold int32 `json:"successThreshold,omitempty" json,yaml:"successThreshold,omitempty"`
