...
// ContextValidate validate this io k8s api core v1 flex persistent volume source based on the context it is used
func (m *IoK8sAPICoreV1FlexPersistentVolumeSource) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1FlexPersistentVolumeSource) contextValidateSecretRef(ctx context.Context, formats strfmt.Registry) error {
