...
// ContextValidate validate this io k8s api core v1 c s i persistent volume source based on the context it is used
func (m *IoK8sAPICoreV1CSIPersistentVolumeSource) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1CSIPersistentVolumeSource) contextValidateControllerExpandSecretRef(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1CSIPersistentVolumeSource) contextValidateControllerPublishSecretRef(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1CSIPersistentVolumeSource) contextValidateNodePublishSecretRef(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1CSIPersistentVolumeSource) contextValidateNodeStageSecretRef(ctx context.Context, formats strfmt.Registry) error {
